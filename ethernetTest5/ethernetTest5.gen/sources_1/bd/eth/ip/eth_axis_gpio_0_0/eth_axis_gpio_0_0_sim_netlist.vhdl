...
-- Date        : Thu Feb 26 13:17:33 2026
-- Host        : DESKTOP-4RVJPC8 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/rfebb/Desktop/Projects/ethernetTest5/ethernetTest5.gen/sources_1/bd/eth/ip/eth_axis_gpio_0_0/eth_axis_gpio_0_0_sim_netlist.vhdl
...
entity eth_axis_gpio_0_0_axis_gpio is
  port (
  ...
  attribute ORIG_REF_NAME of eth_axis_gpio_0_0_axis_gpio : entity is "axis_gpio";
end eth_axis_gpio_0_0_axis_gpio;

architecture STRUCTURE of eth_axis_gpio_0_0_axis_gpio is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity eth_axis_gpio_0_0_debounce is
  port (
    ...
    \data_buffer_reg[30]\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
    SW : in STD_LOGIC_VECTOR ( 15 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of eth_axis_gpio_0_0_debounce : entity is "debounce";
end eth_axis_gpio_0_0_debounce;

architecture STRUCTURE of eth_axis_gpio_0_0_debounce is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \data_buffer[24]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \data_buffer[25]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \data_buffer[29]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \data_buffer[30]_i_2\ : label is "soft_lutpair10";
begin
  SR(0) <= \^sr\(0);
\data_buffer[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2E2E2EEEE2E2E222"
        ...
        port map (
      I0 => Q(0),
      I1 => \data_buffer_reg[0]\,
      I2 => gpio_in_debounced(15),
      I3 => gpio_in_debounced(13),
      I4 => gpio_in_debounced(14),
      I5 => gpio_in_debounced(12),
      O => D(0)
    );
\data_buffer[10]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"EF00FFFFEF000000"
        ...
        port map (
      I0 => gpio_in_debounced(9),
      I1 => gpio_in_debounced(8),
      I2 => gpio_in_debounced(11),
      I3 => gpio_in_debounced(10),
      I4 => \data_buffer_reg[0]\,
      I5 => Q(8),
      O => D(8)
    );
\data_buffer[11]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"02FF0200"
        ...
        port map (
      I0 => gpio_in_debounced(11),
      I1 => gpio_in_debounced(10),
      I2 => gpio_in_debounced(9),
...
\data_buffer[13]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"1FFF1F00"
        ...
        port map (
      I0 => gpio_in_debounced(10),
      I1 => gpio_in_debounced(9),
      I2 => gpio_in_debounced(11),
      I3 => \data_buffer_reg[0]\,
      I4 => Q(10),
      O => D(10)
...
\data_buffer[16]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => Q(12),
      I1 => \data_buffer_reg[0]\,
      I2 => gpio_in_debounced(7),
      I3 => gpio_in_debounced(5),
      I4 => gpio_in_debounced(6),
      I5 => gpio_in_debounced(4),
      O => D(12)
    );
\data_buffer[17]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"EE2222E2EE22EE22"
    )
        port map (
      I0 => Q(13),
      I1 => \data_buffer_reg[0]\,
      I2 => gpio_in_debounced(6),
      I3 => gpio_in_debounced(5),
      I4 => gpio_in_debounced(4),
      I5 => gpio_in_debounced(7),
      O => D(13)
    );
\data_buffer[18]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"EF00FFFFEF000000"
        ...
        port map (
      I0 => gpio_in_debounced(5),
      I1 => gpio_in_debounced(4),
      I2 => gpio_in_debounced(7),
      I3 => gpio_in_debounced(6),
      I4 => \data_buffer_reg[0]\,
      I5 => Q(14),
      O => D(14)
    );
\data_buffer[19]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"02FF0200"
        ...
        port map (
      I0 => gpio_in_debounced(7),
      I1 => gpio_in_debounced(6),
      I2 => gpio_in_debounced(5),
      I3 => \data_buffer_reg[0]\,
      I4 => Q(15),
      O => D(15)
    );
\data_buffer[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => Q(1),
      I1 => \data_buffer_reg[0]\,
      I2 => gpio_in_debounced(14),
      I3 => gpio_in_debounced(13),
      I4 => gpio_in_debounced(12),
      I5 => gpio_in_debounced(15),
      O => D(1)
    );
\data_buffer[21]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"1FFF1F00"
        ...
        port map (
      I0 => gpio_in_debounced(6),
      I1 => gpio_in_debounced(5),
      I2 => gpio_in_debounced(7),
      I3 => \data_buffer_reg[0]\,
      I4 => Q(16),
      O => D(16)
...
\data_buffer[24]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"222A8880"
        ...
        port map (
      I0 => \data_buffer_reg[0]\,
      I1 => gpio_in_debounced(3),
      I2 => gpio_in_debounced(1),
      I3 => gpio_in_debounced(2),
      I4 => gpio_in_debounced(0),
      O => D(18)
    );
\data_buffer[25]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"A008A0A0"
        ...
        port map (
      I0 => \data_buffer_reg[0]\,
      I1 => gpio_in_debounced(2),
      I2 => gpio_in_debounced(1),
      I3 => gpio_in_debounced(0),
      I4 => gpio_in_debounced(3),
      O => D(19)
    );
...
\data_buffer[27]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"10001010"
        ...
        port map (
      I0 => gpio_in_debounced(1),
      I1 => gpio_in_debounced(2),
      I2 => gpio_in_debounced(3),
      I3 => \data_buffer_reg[30]\(0),
      I4 => \data_buffer_reg[30]\(1),
      O => D(21)
    );
\data_buffer[29]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"57005757"
        ...
        port map (
      I0 => gpio_in_debounced(3),
      I1 => gpio_in_debounced(1),
      I2 => gpio_in_debounced(2),
      I3 => \data_buffer_reg[30]\(0),
      I4 => \data_buffer_reg[30]\(1),
      O => D(22)
    );
\data_buffer[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"EF00FFFFEF000000"
        ...
        port map (
      I0 => gpio_in_debounced(13),
      I1 => gpio_in_debounced(12),
      I2 => gpio_in_debounced(15),
      I3 => gpio_in_debounced(14),
      I4 => \data_buffer_reg[0]\,
      I5 => Q(2),
      O => D(2)
    );
\data_buffer[30]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B0B0B000"
        ...
        port map (
      I0 => \data_buffer_reg[30]\(0),
      I1 => \data_buffer_reg[30]\(1),
      I2 => gpio_in_debounced(3),
      I3 => gpio_in_debounced(1),
      I4 => gpio_in_debounced(2),
      O => D(23)
    );
\data_buffer[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"02FF0200"
        ...
        port map (
      I0 => gpio_in_debounced(15),
      I1 => gpio_in_debounced(14),
      I2 => gpio_in_debounced(13),
      I3 => \data_buffer_reg[0]\,
      I4 => Q(3),
      O => D(3)
    );
\data_buffer[5]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"1FFF1F00"
        ...
        port map (
      I0 => gpio_in_debounced(14),
      I1 => gpio_in_debounced(13),
      I2 => gpio_in_debounced(15),
      I3 => \data_buffer_reg[0]\,
      I4 => Q(4),
      O => D(4)
...
\data_buffer[8]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \data_buffer_reg[0]\,
      I2 => gpio_in_debounced(11),
      I3 => gpio_in_debounced(9),
      I4 => gpio_in_debounced(10),
      I5 => gpio_in_debounced(8),
      O => D(6)
    );
\data_buffer[9]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => gpio_in_debounced(10),
      I3 => gpio_in_debounced(9),
      I4 => gpio_in_debounced(8),
      I5 => gpio_in_debounced(11),
      O => D(7)
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity eth_axis_gpio_0_0_xpm_cdc_sync_rst is
  port (
  ...
  attribute DEF_VAL of eth_axis_gpio_0_0_xpm_cdc_sync_rst : entity is "1'b0";
  attribute DEST_SYNC_FF : integer;
  attribute DEST_SYNC_FF of eth_axis_gpio_0_0_xpm_cdc_sync_rst : entity is 4;
  attribute INIT : string;
  attribute INIT of eth_axis_gpio_0_0_xpm_cdc_sync_rst : entity is "0";
  attribute INIT_SYNC_FF : integer;
  attribute INIT_SYNC_FF of eth_axis_gpio_0_0_xpm_cdc_sync_rst : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of eth_axis_gpio_0_0_xpm_cdc_sync_rst : entity is "xpm_cdc_sync_rst";
  attribute SIM_ASSERT_CHK : integer;
  attribute SIM_ASSERT_CHK of eth_axis_gpio_0_0_xpm_cdc_sync_rst : entity is 0;
  attribute VERSION : integer;
  attribute VERSION of eth_axis_gpio_0_0_xpm_cdc_sync_rst : entity is 0;
  attribute XPM_MODULE : string;
  attribute XPM_MODULE of eth_axis_gpio_0_0_xpm_cdc_sync_rst : entity is "TRUE";
  attribute keep_hierarchy : string;
  attribute keep_hierarchy of eth_axis_gpio_0_0_xpm_cdc_sync_rst : entity is "true";
  attribute xpm_cdc : string;
  attribute xpm_cdc of eth_axis_gpio_0_0_xpm_cdc_sync_rst : entity is "SYNC_RST";
end eth_axis_gpio_0_0_xpm_cdc_sync_rst;

architecture STRUCTURE of eth_axis_gpio_0_0_xpm_cdc_sync_rst is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity eth_axis_gpio_0_0_xpm_counter_updn is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of eth_axis_gpio_0_0_xpm_counter_updn : entity is "xpm_counter_updn";
end eth_axis_gpio_0_0_xpm_counter_updn;

architecture STRUCTURE of eth_axis_gpio_0_0_xpm_counter_updn is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \eth_axis_gpio_0_0_xpm_counter_updn__parameterized0\ is
  port (
    DI : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \eth_axis_gpio_0_0_xpm_counter_updn__parameterized0\ : entity is "xpm_counter_updn";
end \eth_axis_gpio_0_0_xpm_counter_updn__parameterized0\;

architecture STRUCTURE of \eth_axis_gpio_0_0_xpm_counter_updn__parameterized0\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \eth_axis_gpio_0_0_xpm_counter_updn__parameterized0_0\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \eth_axis_gpio_0_0_xpm_counter_updn__parameterized0_0\ : entity is "xpm_counter_updn";
end \eth_axis_gpio_0_0_xpm_counter_updn__parameterized0_0\;

architecture STRUCTURE of \eth_axis_gpio_0_0_xpm_counter_updn__parameterized0_0\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \eth_axis_gpio_0_0_xpm_counter_updn__parameterized1\ is
  port (
    Q : out STD_LOGIC_VECTOR ( 5 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \eth_axis_gpio_0_0_xpm_counter_updn__parameterized1\ : entity is "xpm_counter_updn";
end \eth_axis_gpio_0_0_xpm_counter_updn__parameterized1\;

architecture STRUCTURE of \eth_axis_gpio_0_0_xpm_counter_updn__parameterized1\ is
  signal \^q\ : STD_LOGIC_VECTOR ( 5 downto 0 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \eth_axis_gpio_0_0_xpm_counter_updn__parameterized1_1\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \eth_axis_gpio_0_0_xpm_counter_updn__parameterized1_1\ : entity is "xpm_counter_updn";
end \eth_axis_gpio_0_0_xpm_counter_updn__parameterized1_1\;

architecture STRUCTURE of \eth_axis_gpio_0_0_xpm_counter_updn__parameterized1_1\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity eth_axis_gpio_0_0_xpm_fifo_reg_bit is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of eth_axis_gpio_0_0_xpm_fifo_reg_bit : entity is "xpm_fifo_reg_bit";
end eth_axis_gpio_0_0_xpm_fifo_reg_bit;

architecture STRUCTURE of eth_axis_gpio_0_0_xpm_fifo_reg_bit is
  signal \^clr_full\ : STD_LOGIC;
  signal prog_full_i213_in : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity eth_axis_gpio_0_0_xpm_fifo_rst is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of eth_axis_gpio_0_0_xpm_fifo_rst : entity is "xpm_fifo_rst";
end eth_axis_gpio_0_0_xpm_fifo_rst;

architecture STRUCTURE of eth_axis_gpio_0_0_xpm_fifo_rst is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity eth_axis_gpio_0_0_xpm_memory_base is
  port (
    sleep : in STD_LOGIC;
    clka : in STD_LOGIC;
    rsta : in STD_LOGIC;
  ...
  attribute ADDR_WIDTH_A of eth_axis_gpio_0_0_xpm_memory_base : entity is 6;
  attribute ADDR_WIDTH_B : integer;
  attribute ADDR_WIDTH_B of eth_axis_gpio_0_0_xpm_memory_base : entity is 6;
  attribute AUTO_SLEEP_TIME : integer;
  attribute AUTO_SLEEP_TIME of eth_axis_gpio_0_0_xpm_memory_base : entity is 0;
  attribute BYTE_WRITE_WIDTH_A : integer;
  attribute BYTE_WRITE_WIDTH_A of eth_axis_gpio_0_0_xpm_memory_base : entity is 25;
  attribute BYTE_WRITE_WIDTH_B : integer;
  attribute BYTE_WRITE_WIDTH_B of eth_axis_gpio_0_0_xpm_memory_base : entity is 25;
  attribute CASCADE_HEIGHT : integer;
  attribute CASCADE_HEIGHT of eth_axis_gpio_0_0_xpm_memory_base : entity is 0;
  attribute CLOCKING_MODE : integer;
  attribute CLOCKING_MODE of eth_axis_gpio_0_0_xpm_memory_base : entity is 0;
  attribute ECC_BIT_RANGE : string;
  attribute ECC_BIT_RANGE of eth_axis_gpio_0_0_xpm_memory_base : entity is "[7:0]";
  attribute ECC_MODE : integer;
  attribute ECC_MODE of eth_axis_gpio_0_0_xpm_memory_base : entity is 0;
  attribute ECC_TYPE : string;
  attribute ECC_TYPE of eth_axis_gpio_0_0_xpm_memory_base : entity is "NONE";
  attribute IGNORE_INIT_SYNTH : integer;
  attribute IGNORE_INIT_SYNTH of eth_axis_gpio_0_0_xpm_memory_base : entity is 0;
  attribute MAX_NUM_CHAR : integer;
  attribute MAX_NUM_CHAR of eth_axis_gpio_0_0_xpm_memory_base : entity is 0;
  attribute MEMORY_INIT_FILE : string;
  attribute MEMORY_INIT_FILE of eth_axis_gpio_0_0_xpm_memory_base : entity is "none";
  attribute MEMORY_INIT_PARAM : string;
  attribute MEMORY_INIT_PARAM of eth_axis_gpio_0_0_xpm_memory_base : entity is "";
  attribute MEMORY_OPTIMIZATION : string;
  attribute MEMORY_OPTIMIZATION of eth_axis_gpio_0_0_xpm_memory_base : entity is "true";
  attribute MEMORY_PRIMITIVE : integer;
  attribute MEMORY_PRIMITIVE of eth_axis_gpio_0_0_xpm_memory_base : entity is 0;
  attribute MEMORY_SIZE : integer;
  attribute MEMORY_SIZE of eth_axis_gpio_0_0_xpm_memory_base : entity is 1600;
  attribute MEMORY_TYPE : integer;
  attribute MEMORY_TYPE of eth_axis_gpio_0_0_xpm_memory_base : entity is 1;
  attribute MESSAGE_CONTROL : integer;
  attribute MESSAGE_CONTROL of eth_axis_gpio_0_0_xpm_memory_base : entity is 0;
  attribute NUM_CHAR_LOC : integer;
  attribute NUM_CHAR_LOC of eth_axis_gpio_0_0_xpm_memory_base : entity is 0;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of eth_axis_gpio_0_0_xpm_memory_base : entity is "xpm_memory_base";
  attribute P_ECC_MODE : integer;
  attribute P_ECC_MODE of eth_axis_gpio_0_0_xpm_memory_base : entity is 0;
  attribute P_ENABLE_BYTE_WRITE_A : integer;
  attribute P_ENABLE_BYTE_WRITE_A of eth_axis_gpio_0_0_xpm_memory_base : entity is 0;
  attribute P_ENABLE_BYTE_WRITE_B : integer;
  attribute P_ENABLE_BYTE_WRITE_B of eth_axis_gpio_0_0_xpm_memory_base : entity is 0;
  attribute P_MAX_DEPTH_DATA : integer;
  attribute P_MAX_DEPTH_DATA of eth_axis_gpio_0_0_xpm_memory_base : entity is 64;
  attribute P_MEMORY_OPT : string;
  attribute P_MEMORY_OPT of eth_axis_gpio_0_0_xpm_memory_base : entity is "yes";
  attribute P_MEMORY_PRIMITIVE : string;
  attribute P_MEMORY_PRIMITIVE of eth_axis_gpio_0_0_xpm_memory_base : entity is "auto";
  attribute P_MIN_WIDTH_DATA : integer;
  attribute P_MIN_WIDTH_DATA of eth_axis_gpio_0_0_xpm_memory_base : entity is 25;
  attribute P_MIN_WIDTH_DATA_A : integer;
  attribute P_MIN_WIDTH_DATA_A of eth_axis_gpio_0_0_xpm_memory_base : entity is 25;
  attribute P_MIN_WIDTH_DATA_B : integer;
  attribute P_MIN_WIDTH_DATA_B of eth_axis_gpio_0_0_xpm_memory_base : entity is 25;
  attribute P_MIN_WIDTH_DATA_ECC : integer;
  attribute P_MIN_WIDTH_DATA_ECC of eth_axis_gpio_0_0_xpm_memory_base : entity is 25;
  attribute P_MIN_WIDTH_DATA_LDW : integer;
  attribute P_MIN_WIDTH_DATA_LDW of eth_axis_gpio_0_0_xpm_memory_base : entity is 4;
  attribute P_MIN_WIDTH_DATA_SHFT : integer;
  attribute P_MIN_WIDTH_DATA_SHFT of eth_axis_gpio_0_0_xpm_memory_base : entity is 25;
  attribute P_NUM_COLS_WRITE_A : integer;
  attribute P_NUM_COLS_WRITE_A of eth_axis_gpio_0_0_xpm_memory_base : entity is 1;
  attribute P_NUM_COLS_WRITE_B : integer;
  attribute P_NUM_COLS_WRITE_B of eth_axis_gpio_0_0_xpm_memory_base : entity is 1;
  attribute P_NUM_ROWS_READ_A : integer;
  attribute P_NUM_ROWS_READ_A of eth_axis_gpio_0_0_xpm_memory_base : entity is 1;
  attribute P_NUM_ROWS_READ_B : integer;
  attribute P_NUM_ROWS_READ_B of eth_axis_gpio_0_0_xpm_memory_base : entity is 1;
  attribute P_NUM_ROWS_WRITE_A : integer;
  attribute P_NUM_ROWS_WRITE_A of eth_axis_gpio_0_0_xpm_memory_base : entity is 1;
  attribute P_NUM_ROWS_WRITE_B : integer;
  attribute P_NUM_ROWS_WRITE_B of eth_axis_gpio_0_0_xpm_memory_base : entity is 1;
  attribute P_SDP_WRITE_MODE : string;
  attribute P_SDP_WRITE_MODE of eth_axis_gpio_0_0_xpm_memory_base : entity is "yes";
  attribute P_WIDTH_ADDR_LSB_READ_A : integer;
  attribute P_WIDTH_ADDR_LSB_READ_A of eth_axis_gpio_0_0_xpm_memory_base : entity is 0;
  attribute P_WIDTH_ADDR_LSB_READ_B : integer;
  attribute P_WIDTH_ADDR_LSB_READ_B of eth_axis_gpio_0_0_xpm_memory_base : entity is 0;
  attribute P_WIDTH_ADDR_LSB_WRITE_A : integer;
  attribute P_WIDTH_ADDR_LSB_WRITE_A of eth_axis_gpio_0_0_xpm_memory_base : entity is 0;
  attribute P_WIDTH_ADDR_LSB_WRITE_B : integer;
  attribute P_WIDTH_ADDR_LSB_WRITE_B of eth_axis_gpio_0_0_xpm_memory_base : entity is 0;
  attribute P_WIDTH_ADDR_READ_A : integer;
  attribute P_WIDTH_ADDR_READ_A of eth_axis_gpio_0_0_xpm_memory_base : entity is 6;
  attribute P_WIDTH_ADDR_READ_B : integer;
  attribute P_WIDTH_ADDR_READ_B of eth_axis_gpio_0_0_xpm_memory_base : entity is 6;
  attribute P_WIDTH_ADDR_WRITE_A : integer;
  attribute P_WIDTH_ADDR_WRITE_A of eth_axis_gpio_0_0_xpm_memory_base : entity is 6;
  attribute P_WIDTH_ADDR_WRITE_B : integer;
  attribute P_WIDTH_ADDR_WRITE_B of eth_axis_gpio_0_0_xpm_memory_base : entity is 6;
  attribute P_WIDTH_COL_WRITE_A : integer;
  attribute P_WIDTH_COL_WRITE_A of eth_axis_gpio_0_0_xpm_memory_base : entity is 25;
  attribute P_WIDTH_COL_WRITE_B : integer;
  attribute P_WIDTH_COL_WRITE_B of eth_axis_gpio_0_0_xpm_memory_base : entity is 25;
  attribute RAM_DECOMP : string;
  attribute RAM_DECOMP of eth_axis_gpio_0_0_xpm_memory_base : entity is "auto";
  attribute READ_DATA_WIDTH_A : integer;
  attribute READ_DATA_WIDTH_A of eth_axis_gpio_0_0_xpm_memory_base : entity is 25;
  attribute READ_DATA_WIDTH_B : integer;
  attribute READ_DATA_WIDTH_B of eth_axis_gpio_0_0_xpm_memory_base : entity is 25;
  attribute READ_LATENCY_A : integer;
  attribute READ_LATENCY_A of eth_axis_gpio_0_0_xpm_memory_base : entity is 2;
  attribute READ_LATENCY_B : integer;
  attribute READ_LATENCY_B of eth_axis_gpio_0_0_xpm_memory_base : entity is 2;
  attribute READ_RESET_VALUE_A : string;
  attribute READ_RESET_VALUE_A of eth_axis_gpio_0_0_xpm_memory_base : entity is "0";
  attribute READ_RESET_VALUE_B : string;
  attribute READ_RESET_VALUE_B of eth_axis_gpio_0_0_xpm_memory_base : entity is "";
  attribute RST_MODE_A : string;
  attribute RST_MODE_A of eth_axis_gpio_0_0_xpm_memory_base : entity is "SYNC";
  attribute RST_MODE_B : string;
  attribute RST_MODE_B of eth_axis_gpio_0_0_xpm_memory_base : entity is "SYNC";
  attribute SIM_ASSERT_CHK : integer;
  attribute SIM_ASSERT_CHK of eth_axis_gpio_0_0_xpm_memory_base : entity is 0;
  attribute USE_EMBEDDED_CONSTRAINT : integer;
  attribute USE_EMBEDDED_CONSTRAINT of eth_axis_gpio_0_0_xpm_memory_base : entity is 0;
  attribute USE_MEM_INIT : integer;
  attribute USE_MEM_INIT of eth_axis_gpio_0_0_xpm_memory_base : entity is 0;
  attribute USE_MEM_INIT_MMI : integer;
  attribute USE_MEM_INIT_MMI of eth_axis_gpio_0_0_xpm_memory_base : entity is 0;
  attribute VERSION : integer;
  attribute VERSION of eth_axis_gpio_0_0_xpm_memory_base : entity is 0;
  attribute WAKEUP_TIME : integer;
  attribute WAKEUP_TIME of eth_axis_gpio_0_0_xpm_memory_base : entity is 0;
  attribute WRITE_DATA_WIDTH_A : integer;
  attribute WRITE_DATA_WIDTH_A of eth_axis_gpio_0_0_xpm_memory_base : entity is 25;
  attribute WRITE_DATA_WIDTH_B : integer;
  attribute WRITE_DATA_WIDTH_B of eth_axis_gpio_0_0_xpm_memory_base : entity is 25;
  attribute WRITE_MODE_A : integer;
  attribute WRITE_MODE_A of eth_axis_gpio_0_0_xpm_memory_base : entity is 2;
  attribute WRITE_MODE_B : integer;
  attribute WRITE_MODE_B of eth_axis_gpio_0_0_xpm_memory_base : entity is 2;
  attribute WRITE_PROTECT : integer;
  attribute WRITE_PROTECT of eth_axis_gpio_0_0_xpm_memory_base : entity is 1;
  attribute XPM_MODULE : string;
  attribute XPM_MODULE of eth_axis_gpio_0_0_xpm_memory_base : entity is "TRUE";
  attribute keep_hierarchy : string;
  attribute keep_hierarchy of eth_axis_gpio_0_0_xpm_memory_base : entity is "soft";
  attribute rsta_loop_iter : integer;
  attribute rsta_loop_iter of eth_axis_gpio_0_0_xpm_memory_base : entity is 28;
  attribute rstb_loop_iter : integer;
  attribute rstb_loop_iter of eth_axis_gpio_0_0_xpm_memory_base : entity is 28;
end eth_axis_gpio_0_0_xpm_memory_base;

architecture STRUCTURE of eth_axis_gpio_0_0_xpm_memory_base is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity eth_axis_gpio_0_0_xpm_fifo_base is
  port (
    sleep : in STD_LOGIC;
    rst : in STD_LOGIC;
    wr_clk : in STD_LOGIC;
  ...
  attribute CASCADE_HEIGHT : integer;
  attribute CASCADE_HEIGHT of eth_axis_gpio_0_0_xpm_fifo_base : entity is 0;
  attribute CDC_DEST_SYNC_FF : integer;
  attribute CDC_DEST_SYNC_FF of eth_axis_gpio_0_0_xpm_fifo_base : entity is 3;
  attribute COMMON_CLOCK : integer;
  attribute COMMON_CLOCK of eth_axis_gpio_0_0_xpm_fifo_base : entity is 1;
  attribute DOUT_RESET_VALUE : string;
  attribute DOUT_RESET_VALUE of eth_axis_gpio_0_0_xpm_fifo_base : entity is "";
  attribute ECC_MODE : integer;
  attribute ECC_MODE of eth_axis_gpio_0_0_xpm_fifo_base : entity is 0;
  attribute ENABLE_ECC : integer;
  attribute ENABLE_ECC of eth_axis_gpio_0_0_xpm_fifo_base : entity is 0;
  attribute EN_ADV_FEATURE : string;
  attribute EN_ADV_FEATURE of eth_axis_gpio_0_0_xpm_fifo_base : entity is "16'b0001000000000110";
  attribute EN_AE : string;
  attribute EN_AE of eth_axis_gpio_0_0_xpm_fifo_base : entity is "1'b0";
  attribute EN_AF : string;
  attribute EN_AF of eth_axis_gpio_0_0_xpm_fifo_base : entity is "1'b0";
  attribute EN_DVLD : string;
  attribute EN_DVLD of eth_axis_gpio_0_0_xpm_fifo_base : entity is "1'b1";
  attribute EN_OF : string;
  attribute EN_OF of eth_axis_gpio_0_0_xpm_fifo_base : entity is "1'b0";
  attribute EN_PE : string;
  attribute EN_PE of eth_axis_gpio_0_0_xpm_fifo_base : entity is "1'b0";
  attribute EN_PF : string;
  attribute EN_PF of eth_axis_gpio_0_0_xpm_fifo_base : entity is "1'b1";
  attribute EN_RDC : string;
  attribute EN_RDC of eth_axis_gpio_0_0_xpm_fifo_base : entity is "1'b0";
  attribute EN_SIM_ASSERT_ERR : string;
  attribute EN_SIM_ASSERT_ERR of eth_axis_gpio_0_0_xpm_fifo_base : entity is "warning";
  attribute EN_UF : string;
  attribute EN_UF of eth_axis_gpio_0_0_xpm_fifo_base : entity is "1'b0";
  attribute EN_WACK : string;
  attribute EN_WACK of eth_axis_gpio_0_0_xpm_fifo_base : entity is "1'b0";
  attribute EN_WDC : string;
  attribute EN_WDC of eth_axis_gpio_0_0_xpm_fifo_base : entity is "1'b1";
  attribute FG_EQ_ASYM_DOUT : string;
  attribute FG_EQ_ASYM_DOUT of eth_axis_gpio_0_0_xpm_fifo_base : entity is "1'b0";
  attribute FIFO_MEMORY_TYPE : integer;
  attribute FIFO_MEMORY_TYPE of eth_axis_gpio_0_0_xpm_fifo_base : entity is 0;
  attribute FIFO_MEM_TYPE : integer;
  attribute FIFO_MEM_TYPE of eth_axis_gpio_0_0_xpm_fifo_base : entity is 0;
  attribute FIFO_READ_DEPTH : integer;
  attribute FIFO_READ_DEPTH of eth_axis_gpio_0_0_xpm_fifo_base : entity is 64;
  attribute FIFO_READ_LATENCY : integer;
  attribute FIFO_READ_LATENCY of eth_axis_gpio_0_0_xpm_fifo_base : entity is 0;
  attribute FIFO_SIZE : integer;
  attribute FIFO_SIZE of eth_axis_gpio_0_0_xpm_fifo_base : entity is 1600;
  attribute FIFO_WRITE_DEPTH : integer;
  attribute FIFO_WRITE_DEPTH of eth_axis_gpio_0_0_xpm_fifo_base : entity is 64;
  attribute FULL_RESET_VALUE : integer;
  attribute FULL_RESET_VALUE of eth_axis_gpio_0_0_xpm_fifo_base : entity is 1;
  attribute FULL_RST_VAL : string;
  attribute FULL_RST_VAL of eth_axis_gpio_0_0_xpm_fifo_base : entity is "1'b1";
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of eth_axis_gpio_0_0_xpm_fifo_base : entity is "xpm_fifo_base";
  attribute PE_THRESH_ADJ : integer;
  attribute PE_THRESH_ADJ of eth_axis_gpio_0_0_xpm_fifo_base : entity is 3;
  attribute PE_THRESH_MAX : integer;
  attribute PE_THRESH_MAX of eth_axis_gpio_0_0_xpm_fifo_base : entity is 59;
  attribute PE_THRESH_MIN : integer;
  attribute PE_THRESH_MIN of eth_axis_gpio_0_0_xpm_fifo_base : entity is 5;
  attribute PF_THRESH_ADJ : integer;
  attribute PF_THRESH_ADJ of eth_axis_gpio_0_0_xpm_fifo_base : entity is 48;
  attribute PF_THRESH_MAX : integer;
  attribute PF_THRESH_MAX of eth_axis_gpio_0_0_xpm_fifo_base : entity is 59;
  attribute PF_THRESH_MIN : integer;
  attribute PF_THRESH_MIN of eth_axis_gpio_0_0_xpm_fifo_base : entity is 5;
  attribute PROG_EMPTY_THRESH : integer;
  attribute PROG_EMPTY_THRESH of eth_axis_gpio_0_0_xpm_fifo_base : entity is 5;
  attribute PROG_FULL_THRESH : integer;
  attribute PROG_FULL_THRESH of eth_axis_gpio_0_0_xpm_fifo_base : entity is 50;
  attribute RD_DATA_COUNT_WIDTH : integer;
  attribute RD_DATA_COUNT_WIDTH of eth_axis_gpio_0_0_xpm_fifo_base : entity is 7;
  attribute RD_DC_WIDTH_EXT : integer;
  attribute RD_DC_WIDTH_EXT of eth_axis_gpio_0_0_xpm_fifo_base : entity is 7;
  attribute RD_LATENCY : integer;
  attribute RD_LATENCY of eth_axis_gpio_0_0_xpm_fifo_base : entity is 2;
  attribute RD_MODE : integer;
  attribute RD_MODE of eth_axis_gpio_0_0_xpm_fifo_base : entity is 1;
  attribute RD_PNTR_WIDTH : integer;
  attribute RD_PNTR_WIDTH of eth_axis_gpio_0_0_xpm_fifo_base : entity is 6;
  attribute READ_DATA_WIDTH : integer;
  attribute READ_DATA_WIDTH of eth_axis_gpio_0_0_xpm_fifo_base : entity is 25;
  attribute READ_MODE : integer;
  attribute READ_MODE of eth_axis_gpio_0_0_xpm_fifo_base : entity is 1;
  attribute READ_MODE_LL : integer;
  attribute READ_MODE_LL of eth_axis_gpio_0_0_xpm_fifo_base : entity is 1;
  attribute RELATED_CLOCKS : integer;
  attribute RELATED_CLOCKS of eth_axis_gpio_0_0_xpm_fifo_base : entity is 0;
  attribute REMOVE_WR_RD_PROT_LOGIC : integer;
  attribute REMOVE_WR_RD_PROT_LOGIC of eth_axis_gpio_0_0_xpm_fifo_base : entity is 0;
  attribute SIM_ASSERT_CHK : integer;
  attribute SIM_ASSERT_CHK of eth_axis_gpio_0_0_xpm_fifo_base : entity is 0;
  attribute USE_ADV_FEATURES : integer;
  attribute USE_ADV_FEATURES of eth_axis_gpio_0_0_xpm_fifo_base : entity is 825241654;
  attribute VERSION : integer;
  attribute VERSION of eth_axis_gpio_0_0_xpm_fifo_base : entity is 0;
  attribute WAKEUP_TIME : integer;
  attribute WAKEUP_TIME of eth_axis_gpio_0_0_xpm_fifo_base : entity is 0;
  attribute WIDTH_RATIO : integer;
  attribute WIDTH_RATIO of eth_axis_gpio_0_0_xpm_fifo_base : entity is 1;
  attribute WRITE_DATA_WIDTH : integer;
  attribute WRITE_DATA_WIDTH of eth_axis_gpio_0_0_xpm_fifo_base : entity is 25;
  attribute WR_DATA_COUNT_WIDTH : integer;
  attribute WR_DATA_COUNT_WIDTH of eth_axis_gpio_0_0_xpm_fifo_base : entity is 7;
  attribute WR_DC_WIDTH_EXT : integer;
  attribute WR_DC_WIDTH_EXT of eth_axis_gpio_0_0_xpm_fifo_base : entity is 7;
  attribute WR_DEPTH_LOG : integer;
  attribute WR_DEPTH_LOG of eth_axis_gpio_0_0_xpm_fifo_base : entity is 6;
  attribute WR_PNTR_WIDTH : integer;
  attribute WR_PNTR_WIDTH of eth_axis_gpio_0_0_xpm_fifo_base : entity is 6;
  attribute WR_RD_RATIO : integer;
  attribute WR_RD_RATIO of eth_axis_gpio_0_0_xpm_fifo_base : entity is 0;
  attribute WR_WIDTH_LOG : integer;
  attribute WR_WIDTH_LOG of eth_axis_gpio_0_0_xpm_fifo_base : entity is 5;
  attribute XPM_MODULE : string;
  attribute XPM_MODULE of eth_axis_gpio_0_0_xpm_fifo_base : entity is "TRUE";
  attribute both_stages_valid : integer;
  attribute both_stages_valid of eth_axis_gpio_0_0_xpm_fifo_base : entity is 3;
  attribute invalid : integer;
  attribute invalid of eth_axis_gpio_0_0_xpm_fifo_base : entity is 0;
  attribute keep_hierarchy : string;
  attribute keep_hierarchy of eth_axis_gpio_0_0_xpm_fifo_base : entity is "soft";
  attribute stage1_valid : integer;
  attribute stage1_valid of eth_axis_gpio_0_0_xpm_fifo_base : entity is 2;
  attribute stage2_valid : integer;
  attribute stage2_valid of eth_axis_gpio_0_0_xpm_fifo_base : entity is 1;
end eth_axis_gpio_0_0_xpm_fifo_base;

architecture STRUCTURE of eth_axis_gpio_0_0_xpm_fifo_base is
  signal \<const0>\ : STD_LOGIC;
  signal clr_full : STD_LOGIC;
...
\gen_fwft.rdpp1_inst\: entity work.eth_axis_gpio_0_0_xpm_counter_updn
     port map (
...
\gen_sdpram.xpm_memory_base_inst\: entity work.eth_axis_gpio_0_0_xpm_memory_base
     port map (
...
rdp_inst: entity work.\eth_axis_gpio_0_0_xpm_counter_updn__parameterized0\
     port map (
      DI(0) => rdp_inst_n_0,
...
rdpp1_inst: entity work.\eth_axis_gpio_0_0_xpm_counter_updn__parameterized1\
     port map (
      Q(5) => rdpp1_inst_n_0,
      Q(4) => rdpp1_inst_n_1,
      Q(3) => rdpp1_inst_n_2,
...
rst_d1_inst: entity work.eth_axis_gpio_0_0_xpm_fifo_reg_bit
     port map (
...
wrp_inst: entity work.\eth_axis_gpio_0_0_xpm_counter_updn__parameterized0_0\
     port map (
...
wrpp1_inst: entity work.\eth_axis_gpio_0_0_xpm_counter_updn__parameterized1_1\
     port map (
...
xpm_fifo_rst_inst: entity work.eth_axis_gpio_0_0_xpm_fifo_rst
     port map (
      Q(0) => xpm_fifo_rst_inst_n_1,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity eth_axis_gpio_0_0_xpm_fifo_axis is
  port (
  ...
  attribute AXIS_DATA_WIDTH of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 25;
  attribute AXIS_FINAL_DATA_WIDTH : integer;
  attribute AXIS_FINAL_DATA_WIDTH of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 25;
  attribute CASCADE_HEIGHT : integer;
  attribute CASCADE_HEIGHT of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 0;
  attribute CDC_SYNC_STAGES : integer;
  attribute CDC_SYNC_STAGES of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 3;
  attribute CLOCKING_MODE : string;
  attribute CLOCKING_MODE of eth_axis_gpio_0_0_xpm_fifo_axis : entity is "common_clock";
  attribute ECC_MODE : string;
  attribute ECC_MODE of eth_axis_gpio_0_0_xpm_fifo_axis : entity is "no_ecc";
  attribute EN_ADV_FEATURE_AXIS : string;
  attribute EN_ADV_FEATURE_AXIS of eth_axis_gpio_0_0_xpm_fifo_axis : entity is "16'b0001000000000110";
  attribute EN_ADV_FEATURE_AXIS_INT : string;
  attribute EN_ADV_FEATURE_AXIS_INT of eth_axis_gpio_0_0_xpm_fifo_axis : entity is "16'b0001000000000110";
  attribute EN_ALMOST_EMPTY_INT : string;
  attribute EN_ALMOST_EMPTY_INT of eth_axis_gpio_0_0_xpm_fifo_axis : entity is "1'b0";
  attribute EN_ALMOST_FULL_INT : string;
  attribute EN_ALMOST_FULL_INT of eth_axis_gpio_0_0_xpm_fifo_axis : entity is "1'b0";
  attribute EN_DATA_VALID_INT : string;
  attribute EN_DATA_VALID_INT of eth_axis_gpio_0_0_xpm_fifo_axis : entity is "1'b1";
  attribute EN_SIM_ASSERT_ERR : string;
  attribute EN_SIM_ASSERT_ERR of eth_axis_gpio_0_0_xpm_fifo_axis : entity is "warning";
  attribute FIFO_DEPTH : integer;
  attribute FIFO_DEPTH of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 64;
  attribute FIFO_MEMORY_TYPE : string;
  attribute FIFO_MEMORY_TYPE of eth_axis_gpio_0_0_xpm_fifo_axis : entity is "auto";
  attribute LOG_DEPTH_AXIS : integer;
  attribute LOG_DEPTH_AXIS of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 6;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of eth_axis_gpio_0_0_xpm_fifo_axis : entity is "xpm_fifo_axis";
  attribute PACKET_FIFO : string;
  attribute PACKET_FIFO of eth_axis_gpio_0_0_xpm_fifo_axis : entity is "false";
  attribute PKT_SIZE_LT8 : string;
  attribute PKT_SIZE_LT8 of eth_axis_gpio_0_0_xpm_fifo_axis : entity is "1'b0";
  attribute PROG_EMPTY_THRESH : integer;
  attribute PROG_EMPTY_THRESH of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 5;
  attribute PROG_FULL_THRESH : integer;
  attribute PROG_FULL_THRESH of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 50;
  attribute P_COMMON_CLOCK : integer;
  attribute P_COMMON_CLOCK of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 1;
  attribute P_ECC_MODE : integer;
  attribute P_ECC_MODE of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 0;
  attribute P_FIFO_MEMORY_TYPE : integer;
  attribute P_FIFO_MEMORY_TYPE of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 0;
  attribute P_PKT_MODE : integer;
  attribute P_PKT_MODE of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 0;
  attribute RD_DATA_COUNT_WIDTH : integer;
  attribute RD_DATA_COUNT_WIDTH of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 7;
  attribute RELATED_CLOCKS : integer;
  attribute RELATED_CLOCKS of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 0;
  attribute SIM_ASSERT_CHK : integer;
  attribute SIM_ASSERT_CHK of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 0;
  attribute TDATA_OFFSET : integer;
  attribute TDATA_OFFSET of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 8;
  attribute TDATA_WIDTH : integer;
  attribute TDATA_WIDTH of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 8;
  attribute TDEST_OFFSET : integer;
  attribute TDEST_OFFSET of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 12;
  attribute TDEST_WIDTH : integer;
  attribute TDEST_WIDTH of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 1;
  attribute TID_OFFSET : integer;
  attribute TID_OFFSET of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 11;
  attribute TID_WIDTH : integer;
  attribute TID_WIDTH of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 1;
  attribute TKEEP_OFFSET : integer;
  attribute TKEEP_OFFSET of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 10;
  attribute TSTRB_OFFSET : integer;
  attribute TSTRB_OFFSET of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 9;
  attribute TUSER_MAX_WIDTH : integer;
  attribute TUSER_MAX_WIDTH of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 4083;
  attribute TUSER_OFFSET : integer;
  attribute TUSER_OFFSET of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 24;
  attribute TUSER_WIDTH : integer;
  attribute TUSER_WIDTH of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 12;
  attribute USE_ADV_FEATURES : integer;
  attribute USE_ADV_FEATURES of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 825241654;
  attribute USE_ADV_FEATURES_INT : integer;
  attribute USE_ADV_FEATURES_INT of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 825241654;
  attribute WR_DATA_COUNT_WIDTH : integer;
  attribute WR_DATA_COUNT_WIDTH of eth_axis_gpio_0_0_xpm_fifo_axis : entity is 7;
  attribute XPM_MODULE : string;
  attribute XPM_MODULE of eth_axis_gpio_0_0_xpm_fifo_axis : entity is "TRUE";
  attribute dont_touch : string;
  attribute dont_touch of eth_axis_gpio_0_0_xpm_fifo_axis : entity is "true";
end eth_axis_gpio_0_0_xpm_fifo_axis;

architecture STRUCTURE of eth_axis_gpio_0_0_xpm_fifo_axis is
  signal \<const0>\ : STD_LOGIC;
...
\gaxis_rst_sync.xpm_cdc_sync_rst_inst\: entity work.eth_axis_gpio_0_0_xpm_cdc_sync_rst
     port map (
      dest_clk => s_aclk,
      dest_rst => rst_axis,
...
xpm_fifo_base_inst: entity work.eth_axis_gpio_0_0_xpm_fifo_base
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity eth_axis_gpio_0_0_axis_data_fifo_v2_0_13_top is
  port (
    s_axis_tready : out STD_LOGIC;
    m_axis_tvalid : out STD_LOGIC;
    m_axis_tdata : out STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of eth_axis_gpio_0_0_axis_data_fifo_v2_0_13_top : entity is "axis_data_fifo_v2_0_13_top";
end eth_axis_gpio_0_0_axis_data_fifo_v2_0_13_top;

architecture STRUCTURE of eth_axis_gpio_0_0_axis_data_fifo_v2_0_13_top is
...
begin
\gen_fifo.xpm_fifo_axis_inst\: entity work.eth_axis_gpio_0_0_xpm_fifo_axis
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity eth_axis_gpio_0_0_axis_data_fifo_tuser is
  port (
    s_axis_aresetn : in STD_LOGIC;
    s_axis_aclk : in STD_LOGIC;
    s_axis_tvalid : in STD_LOGIC;
  ...
  attribute CHECK_LICENSE_TYPE of eth_axis_gpio_0_0_axis_data_fifo_tuser : entity is "axis_data_fifo_tuser,axis_data_fifo_v2_0_13_top,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of eth_axis_gpio_0_0_axis_data_fifo_tuser : entity is "yes";
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of eth_axis_gpio_0_0_axis_data_fifo_tuser : entity is "axis_data_fifo_tuser";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of eth_axis_gpio_0_0_axis_data_fifo_tuser : entity is "axis_data_fifo_v2_0_13_top,Vivado 2024.1";
end eth_axis_gpio_0_0_axis_data_fifo_tuser;

architecture STRUCTURE of eth_axis_gpio_0_0_axis_data_fifo_tuser is
  signal \<const0>\ : STD_LOGIC;
...
inst: entity work.eth_axis_gpio_0_0_axis_data_fifo_v2_0_13_top
     port map (
      m_axis_tdata(7 downto 0) => m_axis_tdata(7 downto 0),
      m_axis_tlast => m_axis_tlast,
      m_axis_tready => m_axis_tready,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity eth_axis_gpio_0_0_sw_axis is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of eth_axis_gpio_0_0_sw_axis : entity is "sw_axis";
end eth_axis_gpio_0_0_sw_axis;

architecture STRUCTURE of eth_axis_gpio_0_0_sw_axis is
  ...
  signal axis_data_fifo_tuser_i_18_n_0 : STD_LOGIC;
  ...
  signal \data_buffer[30]_i_3_n_0\ : STD_LOGIC;
  ...
  signal postfix_buffer : STD_LOGIC_VECTOR ( 5 to 5 );
  signal \postfix_buffer[10]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[14]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[16]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[18]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[21]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[22]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[24]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[25]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[26]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[29]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[30]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[33]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[36]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[37]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[38]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[40]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[42]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[45]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[46]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[48]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[50]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[53]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[54]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[56]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[57]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[5]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[61]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[62]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[62]_i_2_n_0\ : STD_LOGIC;
  signal \postfix_buffer[66]_i_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer[66]_i_2_n_0\ : STD_LOGIC;
  signal \postfix_buffer[66]_i_3_n_0\ : STD_LOGIC;
  signal \postfix_buffer_reg[11]_inst_sw_axis_i_postfix_buffer_reg_r_6_n_0\ : STD_LOGIC;
  signal \postfix_buffer_reg[12]_inst_sw_axis_i_postfix_buffer_reg_r_1_n_0\ : STD_LOGIC;
  signal \postfix_buffer_reg[19]_srl7___inst_sw_axis_i_postfix_buffer_reg_r_5_n_0\ : STD_LOGIC;
  signal \postfix_buffer_reg[20]_srl2___inst_sw_axis_i_postfix_buffer_reg_r_0_n_0\ : STD_LOGIC;
  signal \postfix_buffer_reg_gate__0_n_0\ : STD_LOGIC;
  signal postfix_buffer_reg_gate_n_0 : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[0]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[10]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[13]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[14]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[16]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[17]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[18]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[1]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[21]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[22]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[24]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[25]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[26]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[29]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[2]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[30]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[32]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[33]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[34]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[36]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[37]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[38]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[3]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[40]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[41]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[42]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[44]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[45]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[46]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[48]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[49]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[4]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[50]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[52]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[53]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[54]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[56]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[57]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[58]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[5]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[60]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[61]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[62]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[64]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[65]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[66]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[6]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[8]\ : STD_LOGIC;
  signal \postfix_buffer_reg_n_0_[9]\ : STD_LOGIC;
  signal postfix_buffer_reg_r_0_n_0 : STD_LOGIC;
  signal postfix_buffer_reg_r_1_n_0 : STD_LOGIC;
  signal postfix_buffer_reg_r_2_n_0 : STD_LOGIC;
  signal postfix_buffer_reg_r_3_n_0 : STD_LOGIC;
  signal postfix_buffer_reg_r_4_n_0 : STD_LOGIC;
  signal postfix_buffer_reg_r_5_n_0 : STD_LOGIC;
  signal postfix_buffer_reg_r_6_n_0 : STD_LOGIC;
  signal postfix_buffer_reg_r_n_0 : STD_LOGIC;
  signal prefix_buffer : STD_LOGIC_VECTOR ( 6 to 6 );
  signal \prefix_buffer[100]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[101]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \prefix_buffer[109]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \prefix_buffer[131]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[134]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[136]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[136]_i_2_n_0\ : STD_LOGIC;
  signal \prefix_buffer[13]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[142]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \prefix_buffer[18]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[19]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[21]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[22]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[28]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[29]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[2]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[30]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[32]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[34]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[37]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[38]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[41]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[44]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[45]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \prefix_buffer[53]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[54]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[58]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[60]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[61]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[62]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[64]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[66]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[68]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[69]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[6]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[70]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[73]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[76]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[77]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[78]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[80]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[82]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[85]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[86]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[8]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[93]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer[97]_i_1_n_0\ : STD_LOGIC;
  signal \prefix_buffer_reg[113]_inst_sw_axis_i_prefix_buffer_reg_r_8_n_0\ : STD_LOGIC;
  signal \prefix_buffer_reg[116]_inst_sw_axis_i_prefix_buffer_reg_r_9_n_0\ : STD_LOGIC;
  signal \prefix_buffer_reg[121]_srl2___inst_sw_axis_i_prefix_buffer_reg_r_7_n_0\ : STD_LOGIC;
  signal \prefix_buffer_reg[124]_srl3___inst_sw_axis_i_prefix_buffer_reg_r_8_n_0\ : STD_LOGIC;
  signal \prefix_buffer_reg[17]_srl3___inst_sw_axis_i_prefix_buffer_reg_r_8_n_0\ : STD_LOGIC;
  signal \prefix_buffer_reg[35]_inst_sw_axis_i_prefix_buffer_reg_r_17_n_0\ : STD_LOGIC;
  signal \prefix_buffer_reg[43]_srl11___inst_sw_axis_i_prefix_buffer_reg_r_16_n_0\ : STD_LOGIC;
  signal \prefix_buffer_reg[9]_inst_sw_axis_i_prefix_buffer_reg_r_9_n_0\ : STD_LOGIC;
  ...
  signal \prefix_buffer_reg_n_0_[100]\ : STD_LOGIC;
  signal \prefix_buffer_reg_n_0_[101]\ : STD_LOGIC;
  ...
  signal \prefix_buffer_reg_n_0_[108]\ : STD_LOGIC;
  signal \prefix_buffer_reg_n_0_[109]\ : STD_LOGIC;
  ...
  signal \prefix_buffer_reg_n_0_[21]\ : STD_LOGIC;
  ...
  signal \prefix_buffer_reg_n_0_[29]\ : STD_LOGIC;
  ...
  signal \prefix_buffer_reg_n_0_[37]\ : STD_LOGIC;
  ...
  signal \prefix_buffer_reg_n_0_[45]\ : STD_LOGIC;
  ...
  signal \prefix_buffer_reg_n_0_[53]\ : STD_LOGIC;
  ...
  signal \prefix_buffer_reg_n_0_[61]\ : STD_LOGIC;
  ...
  signal \prefix_buffer_reg_n_0_[66]\ : STD_LOGIC;
  ...
  signal \prefix_buffer_reg_n_0_[74]\ : STD_LOGIC;
  signal \prefix_buffer_reg_n_0_[76]\ : STD_LOGIC;
  ...
  signal \prefix_buffer_reg_n_0_[82]\ : STD_LOGIC;
  signal \prefix_buffer_reg_n_0_[84]\ : STD_LOGIC;
  signal \prefix_buffer_reg_n_0_[85]\ : STD_LOGIC;
  ...
  signal \prefix_buffer_reg_n_0_[90]\ : STD_LOGIC;
  signal \prefix_buffer_reg_n_0_[92]\ : STD_LOGIC;
  signal \prefix_buffer_reg_n_0_[93]\ : STD_LOGIC;
  ...
  signal prefix_buffer_reg_r_10_n_0 : STD_LOGIC;
  signal prefix_buffer_reg_r_11_n_0 : STD_LOGIC;
  signal prefix_buffer_reg_r_12_n_0 : STD_LOGIC;
  signal prefix_buffer_reg_r_13_n_0 : STD_LOGIC;
  signal prefix_buffer_reg_r_14_n_0 : STD_LOGIC;
  signal prefix_buffer_reg_r_15_n_0 : STD_LOGIC;
  signal prefix_buffer_reg_r_16_n_0 : STD_LOGIC;
  signal prefix_buffer_reg_r_17_n_0 : STD_LOGIC;
  ...
  signal send_trigger_i_2_n_0 : STD_LOGIC;
  signal send_trigger_i_3_n_0 : STD_LOGIC;
  signal send_trigger_i_4_n_0 : STD_LOGIC;
  signal send_trigger_i_5_n_0 : STD_LOGIC;
  signal send_trigger_reg_n_0 : STD_LOGIC;
  ...
  signal timer_reg : STD_LOGIC_VECTOR ( 22 downto 0 );
  ...
  signal \NLW_i_/i__carry__4_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_i_/i__carry__4_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_current_state[1]_i_3\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \FSM_sequential_current_state[1]_i_5\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \FSM_sequential_current_state[1]_i_6\ : label is "soft_lutpair48";
  attribute FSM_ENCODED_STATES : string;
  ...
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of axis_data_fifo_tuser : label is "axis_data_fifo_tuser,axis_data_fifo_v2_0_13_top,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of axis_data_fifo_tuser : label is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of axis_data_fifo_tuser : label is "axis_data_fifo_v2_0_13_top,Vivado 2024.1";
  attribute SOFT_HLUTNM of axis_data_fifo_tuser_i_1 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of axis_data_fifo_tuser_i_10 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of axis_data_fifo_tuser_i_12 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of axis_data_fifo_tuser_i_13 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \data_buffer[30]_i_3\ : label is "soft_lutpair14";
  attribute srl_bus_name : string;
  attribute srl_bus_name of \postfix_buffer_reg[19]_srl7___inst_sw_axis_i_postfix_buffer_reg_r_5\ : label is "\inst/sw_axis_i/postfix_buffer_reg ";
  attribute srl_name : string;
  attribute srl_name of \postfix_buffer_reg[19]_srl7___inst_sw_axis_i_postfix_buffer_reg_r_5\ : label is "\inst/sw_axis_i/postfix_buffer_reg[19]_srl7___inst_sw_axis_i_postfix_buffer_reg_r_5 ";
  attribute srl_bus_name of \postfix_buffer_reg[20]_srl2___inst_sw_axis_i_postfix_buffer_reg_r_0\ : label is "\inst/sw_axis_i/postfix_buffer_reg ";
  attribute srl_name of \postfix_buffer_reg[20]_srl2___inst_sw_axis_i_postfix_buffer_reg_r_0\ : label is "\inst/sw_axis_i/postfix_buffer_reg[20]_srl2___inst_sw_axis_i_postfix_buffer_reg_r_0 ";
  attribute SOFT_HLUTNM of \prefix_buffer[100]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \prefix_buffer[101]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \prefix_buffer[102]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \prefix_buffer[104]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \prefix_buffer[106]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \prefix_buffer[109]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \prefix_buffer[10]_i_1\ : label is "soft_lutpair45";
  attribute SOFT_HLUTNM of \prefix_buffer[110]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \prefix_buffer[112]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \prefix_buffer[118]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \prefix_buffer[122]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \prefix_buffer[126]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \prefix_buffer[128]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \prefix_buffer[131]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \prefix_buffer[134]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \prefix_buffer[13]_i_1\ : label is "soft_lutpair45";
  attribute SOFT_HLUTNM of \prefix_buffer[142]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \prefix_buffer[14]_i_1\ : label is "soft_lutpair44";
  attribute SOFT_HLUTNM of \prefix_buffer[16]_i_1\ : label is "soft_lutpair44";
  attribute SOFT_HLUTNM of \prefix_buffer[18]_i_1\ : label is "soft_lutpair43";
  attribute SOFT_HLUTNM of \prefix_buffer[19]_i_1\ : label is "soft_lutpair43";
  attribute SOFT_HLUTNM of \prefix_buffer[21]_i_1\ : label is "soft_lutpair42";
  attribute SOFT_HLUTNM of \prefix_buffer[22]_i_1\ : label is "soft_lutpair42";
  attribute SOFT_HLUTNM of \prefix_buffer[28]_i_1\ : label is "soft_lutpair41";
  attribute SOFT_HLUTNM of \prefix_buffer[29]_i_1\ : label is "soft_lutpair41";
  attribute SOFT_HLUTNM of \prefix_buffer[2]_i_1\ : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \prefix_buffer[30]_i_1\ : label is "soft_lutpair40";
  attribute SOFT_HLUTNM of \prefix_buffer[32]_i_1\ : label is "soft_lutpair40";
  attribute SOFT_HLUTNM of \prefix_buffer[34]_i_1\ : label is "soft_lutpair39";
  attribute SOFT_HLUTNM of \prefix_buffer[37]_i_1\ : label is "soft_lutpair39";
  attribute SOFT_HLUTNM of \prefix_buffer[38]_i_1\ : label is "soft_lutpair38";
  attribute SOFT_HLUTNM of \prefix_buffer[41]_i_1\ : label is "soft_lutpair38";
  attribute SOFT_HLUTNM of \prefix_buffer[44]_i_1\ : label is "soft_lutpair37";
  attribute SOFT_HLUTNM of \prefix_buffer[45]_i_1\ : label is "soft_lutpair37";
  attribute SOFT_HLUTNM of \prefix_buffer[46]_i_1\ : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \prefix_buffer[48]_i_1\ : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \prefix_buffer[4]_i_1\ : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \prefix_buffer[53]_i_1\ : label is "soft_lutpair35";
  attribute SOFT_HLUTNM of \prefix_buffer[54]_i_1\ : label is "soft_lutpair35";
  attribute SOFT_HLUTNM of \prefix_buffer[58]_i_1\ : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of \prefix_buffer[60]_i_1\ : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of \prefix_buffer[61]_i_1\ : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of \prefix_buffer[62]_i_1\ : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of \prefix_buffer[64]_i_1\ : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \prefix_buffer[66]_i_1\ : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \prefix_buffer[68]_i_1\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \prefix_buffer[69]_i_1\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \prefix_buffer[6]_i_1\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \prefix_buffer[70]_i_1\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \prefix_buffer[73]_i_1\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \prefix_buffer[76]_i_1\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \prefix_buffer[77]_i_1\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \prefix_buffer[78]_i_1\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \prefix_buffer[80]_i_1\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \prefix_buffer[82]_i_1\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \prefix_buffer[85]_i_1\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \prefix_buffer[86]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \prefix_buffer[8]_i_1\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \prefix_buffer[93]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \prefix_buffer[97]_i_1\ : label is "soft_lutpair25";
  attribute srl_bus_name of \prefix_buffer_reg[121]_srl2___inst_sw_axis_i_prefix_buffer_reg_r_7\ : label is "\inst/sw_axis_i/prefix_buffer_reg ";
  attribute srl_name of \prefix_buffer_reg[121]_srl2___inst_sw_axis_i_prefix_buffer_reg_r_7\ : label is "\inst/sw_axis_i/prefix_buffer_reg[121]_srl2___inst_sw_axis_i_prefix_buffer_reg_r_7 ";
  attribute srl_bus_name of \prefix_buffer_reg[124]_srl3___inst_sw_axis_i_prefix_buffer_reg_r_8\ : label is "\inst/sw_axis_i/prefix_buffer_reg ";
  attribute srl_name of \prefix_buffer_reg[124]_srl3___inst_sw_axis_i_prefix_buffer_reg_r_8\ : label is "\inst/sw_axis_i/prefix_buffer_reg[124]_srl3___inst_sw_axis_i_prefix_buffer_reg_r_8 ";
  attribute srl_bus_name of \prefix_buffer_reg[17]_srl3___inst_sw_axis_i_prefix_buffer_reg_r_8\ : label is "\inst/sw_axis_i/prefix_buffer_reg ";
  attribute srl_name of \prefix_buffer_reg[17]_srl3___inst_sw_axis_i_prefix_buffer_reg_r_8\ : label is "\inst/sw_axis_i/prefix_buffer_reg[17]_srl3___inst_sw_axis_i_prefix_buffer_reg_r_8 ";
  attribute srl_bus_name of \prefix_buffer_reg[43]_srl11___inst_sw_axis_i_prefix_buffer_reg_r_16\ : label is "\inst/sw_axis_i/prefix_buffer_reg ";
  attribute srl_name of \prefix_buffer_reg[43]_srl11___inst_sw_axis_i_prefix_buffer_reg_r_16\ : label is "\inst/sw_axis_i/prefix_buffer_reg[43]_srl11___inst_sw_axis_i_prefix_buffer_reg_r_16 ";
  attribute SOFT_HLUTNM of prefix_buffer_reg_gate : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \prefix_buffer_reg_gate__2\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \state_counter[0]_i_11\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \state_counter[0]_i_4\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \state_counter[0]_i_6\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \state_counter[0]_i_9\ : label is "soft_lutpair15";
  attribute ADDER_THRESHOLD : integer;
...
\FSM_sequential_current_state[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \postfix_buffer[66]_i_2_n_0\,
      I2 => state_counter_reg(4),
      I3 => \prefix_buffer[136]_i_2_n_0\,
...
\FSM_sequential_current_state[0]_i_5\: unisim.vcomponents.LUT4
    generic map(
      ...
      I2 => axis_data_fifo_tuser_i_15_n_0,
...
\FSM_sequential_current_state[2]_i_2\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => axis_data_fifo_tuser_i_14_n_0,
      I3 => axis_data_fifo_tuser_i_13_n_0,
...
axis_data_fifo_tuser: entity work.eth_axis_gpio_0_0_axis_data_fifo_tuser
     port map (
...
axis_data_fifo_tuser_i_10: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
axis_data_fifo_tuser_i_11: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
      I0 => axis_data_fifo_tuser_i_12_n_0,
      I1 => axis_data_fifo_tuser_i_13_n_0,
      I2 => axis_data_fifo_tuser_i_14_n_0,
...
axis_data_fifo_tuser_i_14: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
      ...
      I3 => axis_data_fifo_tuser_i_17_n_0,
      I4 => axis_data_fifo_tuser_i_18_n_0,
...
axis_data_fifo_tuser_i_18: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      O => axis_data_fifo_tuser_i_18_n_0
    );
axis_data_fifo_tuser_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000F0CCAA00"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[6]\,
      I1 => \data_buffer_reg_n_0_[6]\,
      I2 => \postfix_buffer_reg_n_0_[6]\,
      I3 => current_state(0),
      I4 => current_state(1),
      I5 => current_state(2),
      O => axis_data(6)
    );
axis_data_fifo_tuser_i_3: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000F0CCAA00"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[5]\,
      I1 => \data_buffer_reg_n_0_[5]\,
      I2 => \postfix_buffer_reg_n_0_[5]\,
      I3 => current_state(0),
      I4 => current_state(1),
      I5 => current_state(2),
      O => axis_data(5)
    );
axis_data_fifo_tuser_i_4: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000F0CCAA00"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[4]\,
      I1 => \data_buffer_reg_n_0_[5]\,
      I2 => \postfix_buffer_reg_n_0_[4]\,
      I3 => current_state(0),
      I4 => current_state(1),
      I5 => current_state(2),
      O => axis_data(4)
...
axis_data_fifo_tuser_i_9: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => axis_data_fifo_tuser_i_11_n_0,
      O => axis_last
    );
...
\data_buffer[30]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFD"
    )
        port map (
...
debounce_i: entity work.eth_axis_gpio_0_0_debounce
     port map (
      D(23 downto 22) => data_buffer0_in(30 downto 29),
      D(21 downto 18) => data_buffer0_in(27 downto 24),
      D(17 downto 16) => data_buffer0_in(22 downto 21),
      D(15 downto 12) => data_buffer0_in(19 downto 16),
      D(11 downto 10) => data_buffer0_in(14 downto 13),
      D(9 downto 6) => data_buffer0_in(11 downto 8),
      D(5 downto 4) => data_buffer0_in(6 downto 5),
      D(3 downto 0) => data_buffer0_in(3 downto 0),
      Q(17) => \data_buffer_reg_n_0_[30]\,
      Q(16) => \data_buffer_reg_n_0_[29]\,
      Q(15) => \data_buffer_reg_n_0_[27]\,
      Q(14) => \data_buffer_reg_n_0_[26]\,
      Q(13) => \data_buffer_reg_n_0_[25]\,
      Q(12) => \data_buffer_reg_n_0_[24]\,
      Q(11) => \data_buffer_reg_n_0_[22]\,
      Q(10) => \data_buffer_reg_n_0_[21]\,
      Q(9) => \data_buffer_reg_n_0_[19]\,
      Q(8) => \data_buffer_reg_n_0_[18]\,
      Q(7) => \data_buffer_reg_n_0_[17]\,
      Q(6) => \data_buffer_reg_n_0_[16]\,
      Q(5) => \data_buffer_reg_n_0_[14]\,
      Q(4) => \data_buffer_reg_n_0_[13]\,
      Q(3) => \data_buffer_reg_n_0_[11]\,
      Q(2) => \data_buffer_reg_n_0_[10]\,
      Q(1) => \data_buffer_reg_n_0_[9]\,
      Q(0) => \data_buffer_reg_n_0_[8]\,
      SR(0) => debounce_i_n_0,
      SW(15 downto 0) => SW(15 downto 0),
      \data_buffer_reg[0]\ => \postfix_buffer[66]_i_3_n_0\,
      \data_buffer_reg[30]\(1 downto 0) => current_state(1 downto 0),
...
\i_/i__carry__4\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 2) => \NLW_i_/i__carry__4_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \i_/i__carry__4_n_2\,
      CO(0) => \i_/i__carry__4_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \NLW_i_/i__carry__4_O_UNCONNECTED\(3),
      O(2) => \i_/i__carry__4_n_5\,
      O(1) => \i_/i__carry__4_n_6\,
      O(0) => \i_/i__carry__4_n_7\,
      S(3) => '0',
      S(2 downto 0) => timer_reg(22 downto 20)
    );
...
\postfix_buffer[10]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[18]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[10]_i_1_n_0\
    );
\postfix_buffer[14]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[22]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[14]_i_1_n_0\
    );
\postfix_buffer[16]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[24]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[16]_i_1_n_0\
    );
\postfix_buffer[18]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[26]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[18]_i_1_n_0\
    );
\postfix_buffer[21]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[29]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[21]_i_1_n_0\
    );
\postfix_buffer[22]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[30]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[22]_i_1_n_0\
    );
\postfix_buffer[24]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[32]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[24]_i_1_n_0\
    );
\postfix_buffer[25]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[33]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[25]_i_1_n_0\
    );
\postfix_buffer[26]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[34]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[26]_i_1_n_0\
    );
\postfix_buffer[29]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[37]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[29]_i_1_n_0\
    );
\postfix_buffer[30]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[38]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[30]_i_1_n_0\
    );
\postfix_buffer[33]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[41]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[33]_i_1_n_0\
    );
\postfix_buffer[36]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[44]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[36]_i_1_n_0\
    );
\postfix_buffer[37]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[45]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[37]_i_1_n_0\
    );
\postfix_buffer[38]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[46]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[38]_i_1_n_0\
    );
\postfix_buffer[40]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[48]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[40]_i_1_n_0\
    );
\postfix_buffer[42]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[50]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[42]_i_1_n_0\
    );
\postfix_buffer[45]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[53]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[45]_i_1_n_0\
    );
\postfix_buffer[46]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[54]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[46]_i_1_n_0\
    );
\postfix_buffer[48]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[56]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[48]_i_1_n_0\
    );
\postfix_buffer[50]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[58]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[50]_i_1_n_0\
    );
\postfix_buffer[53]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[61]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[53]_i_1_n_0\
    );
\postfix_buffer[54]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[62]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[54]_i_1_n_0\
    );
\postfix_buffer[56]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[64]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[56]_i_1_n_0\
    );
\postfix_buffer[57]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[65]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[57]_i_1_n_0\
    );
\postfix_buffer[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[13]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[5]_i_1_n_0\
    );
\postfix_buffer[60]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
      I0 => state_counter_reg(3),
      I1 => \postfix_buffer[66]_i_3_n_0\,
      I2 => axis_data_fifo_tuser_i_10_n_0,
      I3 => state_counter_reg(4),
      I4 => state_counter_reg(2),
      I5 => axis_data_fifo_tuser_i_11_n_0,
...
\postfix_buffer[61]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[60]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[61]_i_1_n_0\
    );
\postfix_buffer[62]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer[66]_i_2_n_0\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[62]_i_1_n_0\
    );
\postfix_buffer[62]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAABAAA"
    )
        port map (
      I0 => \postfix_buffer_reg_n_0_[52]\,
      I1 => \FSM_sequential_current_state[2]_i_2_n_0\,
      I2 => state_counter_reg(1),
      I3 => state_counter_reg(0),
      I4 => \postfix_buffer[66]_i_3_n_0\,
      I5 => state_counter_reg(3),
      O => \postfix_buffer[62]_i_2_n_0\
    );
\postfix_buffer[66]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => state_counter_reg(1),
      I2 => state_counter_reg(0),
      I3 => \postfix_buffer[66]_i_3_n_0\,
      I4 => state_counter_reg(3),
      I5 => m00_axis_aresetn,
      O => \postfix_buffer[66]_i_1_n_0\
    );
\postfix_buffer[66]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
      ...
      I1 => current_state(1),
      I2 => current_state(2),
      O => \postfix_buffer[66]_i_2_n_0\
    );
\postfix_buffer[66]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FD"
    )
        port map (
      ...
      I1 => current_state(2),
      I2 => current_state(0),
      O => \postfix_buffer[66]_i_3_n_0\
    );
\postfix_buffer_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => \postfix_buffer_reg_n_0_[8]\,
      Q => \postfix_buffer_reg_n_0_[0]\,
      R => \postfix_buffer[66]_i_1_n_0\
    );
\postfix_buffer_reg[10]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[10]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[10]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[11]_inst_sw_axis_i_postfix_buffer_reg_r_6\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => \postfix_buffer_reg[19]_srl7___inst_sw_axis_i_postfix_buffer_reg_r_5_n_0\,
      Q => \postfix_buffer_reg[11]_inst_sw_axis_i_postfix_buffer_reg_r_6_n_0\,
      R => '0'
    );
\postfix_buffer_reg[12]_inst_sw_axis_i_postfix_buffer_reg_r_1\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => \postfix_buffer_reg[20]_srl2___inst_sw_axis_i_postfix_buffer_reg_r_0_n_0\,
      Q => \postfix_buffer_reg[12]_inst_sw_axis_i_postfix_buffer_reg_r_1_n_0\,
      R => '0'
    );
\postfix_buffer_reg[13]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => \postfix_buffer_reg_n_0_[21]\,
      Q => \postfix_buffer_reg_n_0_[13]\,
      R => \postfix_buffer[66]_i_1_n_0\
    );
\postfix_buffer_reg[14]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[14]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[14]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[16]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[16]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[16]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[17]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => \postfix_buffer_reg_n_0_[25]\,
      Q => \postfix_buffer_reg_n_0_[17]\,
      R => \postfix_buffer[66]_i_1_n_0\
    );
\postfix_buffer_reg[18]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[18]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[18]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[19]_srl7___inst_sw_axis_i_postfix_buffer_reg_r_5\: unisim.vcomponents.SRL16E
     port map (
      A0 => '0',
      A1 => '1',
      A2 => '1',
      ...
      CE => \postfix_buffer[66]_i_2_n_0\,
      CLK => m00_axis_aclk,
      D => \postfix_buffer_reg_n_0_[65]\,
      Q => \postfix_buffer_reg[19]_srl7___inst_sw_axis_i_postfix_buffer_reg_r_5_n_0\
    );
\postfix_buffer_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => \postfix_buffer_reg_n_0_[9]\,
      Q => \postfix_buffer_reg_n_0_[1]\,
      R => \postfix_buffer[66]_i_1_n_0\
    );
\postfix_buffer_reg[20]_srl2___inst_sw_axis_i_postfix_buffer_reg_r_0\: unisim.vcomponents.SRL16E
     port map (
      A0 => '1',
      A1 => '0',
      A2 => '0',
      ...
      CE => \postfix_buffer[66]_i_2_n_0\,
      CLK => m00_axis_aclk,
      D => \postfix_buffer_reg_n_0_[36]\,
      Q => \postfix_buffer_reg[20]_srl2___inst_sw_axis_i_postfix_buffer_reg_r_0_n_0\
    );
\postfix_buffer_reg[21]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[21]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[21]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[22]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[22]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[22]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[24]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[24]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[24]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[25]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[25]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[25]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[26]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[26]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[26]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[29]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[29]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[29]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => \postfix_buffer_reg_n_0_[10]\,
      Q => \postfix_buffer_reg_n_0_[2]\,
      R => \postfix_buffer[66]_i_1_n_0\
    );
\postfix_buffer_reg[30]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[30]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[30]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[32]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => \postfix_buffer_reg_n_0_[40]\,
      Q => \postfix_buffer_reg_n_0_[32]\,
      R => \postfix_buffer[66]_i_1_n_0\
    );
\postfix_buffer_reg[33]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[33]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[33]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[34]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => \postfix_buffer_reg_n_0_[42]\,
      Q => \postfix_buffer_reg_n_0_[34]\,
      R => \postfix_buffer[66]_i_1_n_0\
    );
\postfix_buffer_reg[36]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[36]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[36]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[37]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[37]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[37]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[38]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[38]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[38]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => \postfix_buffer_reg_gate__0_n_0\,
      Q => \postfix_buffer_reg_n_0_[3]\,
      R => \postfix_buffer[66]_i_1_n_0\
    );
\postfix_buffer_reg[40]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[40]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[40]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[41]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => \postfix_buffer_reg_n_0_[49]\,
      Q => \postfix_buffer_reg_n_0_[41]\,
      R => \postfix_buffer[66]_i_1_n_0\
    );
\postfix_buffer_reg[42]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[42]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[42]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[44]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => \postfix_buffer_reg_n_0_[52]\,
      Q => \postfix_buffer_reg_n_0_[44]\,
      R => \postfix_buffer[66]_i_1_n_0\
    );
\postfix_buffer_reg[45]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[45]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[45]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[46]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[46]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[46]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[48]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[48]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[48]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[49]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => \postfix_buffer_reg_n_0_[57]\,
      Q => \postfix_buffer_reg_n_0_[49]\,
      R => \postfix_buffer[66]_i_1_n_0\
    );
\postfix_buffer_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => postfix_buffer_reg_gate_n_0,
      Q => \postfix_buffer_reg_n_0_[4]\,
      R => \postfix_buffer[66]_i_1_n_0\
    );
\postfix_buffer_reg[50]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[50]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[50]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[52]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => \postfix_buffer_reg_n_0_[60]\,
      Q => \postfix_buffer_reg_n_0_[52]\,
      R => \postfix_buffer[66]_i_1_n_0\
    );
\postfix_buffer_reg[53]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[53]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[53]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[54]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[54]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[54]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[56]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[56]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[56]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[57]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[57]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[57]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[58]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => \postfix_buffer_reg_n_0_[66]\,
      Q => \postfix_buffer_reg_n_0_[58]\,
      R => \postfix_buffer[66]_i_1_n_0\
    );
\postfix_buffer_reg[5]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[5]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[5]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[60]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => postfix_buffer(5),
      Q => \postfix_buffer_reg_n_0_[60]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[61]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[61]_i_1_n_0\,
      Q => \postfix_buffer_reg_n_0_[61]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[62]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[62]_i_1_n_0\,
      D => \postfix_buffer[62]_i_2_n_0\,
      Q => \postfix_buffer_reg_n_0_[62]\,
      R => debounce_i_n_0
    );
\postfix_buffer_reg[64]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => \postfix_buffer_reg_n_0_[62]\,
      Q => \postfix_buffer_reg_n_0_[64]\,
      R => \postfix_buffer[66]_i_1_n_0\
    );
\postfix_buffer_reg[65]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => \postfix_buffer_reg_n_0_[61]\,
      Q => \postfix_buffer_reg_n_0_[65]\,
      R => \postfix_buffer[66]_i_1_n_0\
    );
\postfix_buffer_reg[66]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => \postfix_buffer_reg_n_0_[44]\,
      Q => \postfix_buffer_reg_n_0_[66]\,
      R => \postfix_buffer[66]_i_1_n_0\
    );
\postfix_buffer_reg[6]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => \postfix_buffer_reg_n_0_[14]\,
      Q => \postfix_buffer_reg_n_0_[6]\,
      R => \postfix_buffer[66]_i_1_n_0\
    );
\postfix_buffer_reg[8]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => \postfix_buffer_reg_n_0_[16]\,
      Q => \postfix_buffer_reg_n_0_[8]\,
      R => \postfix_buffer[66]_i_1_n_0\
    );
\postfix_buffer_reg[9]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => \postfix_buffer_reg_n_0_[17]\,
      Q => \postfix_buffer_reg_n_0_[9]\,
      R => \postfix_buffer[66]_i_1_n_0\
    );
postfix_buffer_reg_gate: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => \postfix_buffer_reg[12]_inst_sw_axis_i_postfix_buffer_reg_r_1_n_0\,
      I1 => postfix_buffer_reg_r_1_n_0,
      O => postfix_buffer_reg_gate_n_0
    );
\postfix_buffer_reg_gate__0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => \postfix_buffer_reg[11]_inst_sw_axis_i_postfix_buffer_reg_r_6_n_0\,
      I1 => postfix_buffer_reg_r_6_n_0,
      O => \postfix_buffer_reg_gate__0_n_0\
    );
postfix_buffer_reg_r: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => '1',
      Q => postfix_buffer_reg_r_n_0,
      R => \postfix_buffer[66]_i_1_n_0\
    );
postfix_buffer_reg_r_0: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => postfix_buffer_reg_r_n_0,
      Q => postfix_buffer_reg_r_0_n_0,
      R => \postfix_buffer[66]_i_1_n_0\
    );
postfix_buffer_reg_r_1: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => postfix_buffer_reg_r_0_n_0,
      Q => postfix_buffer_reg_r_1_n_0,
      R => \postfix_buffer[66]_i_1_n_0\
    );
postfix_buffer_reg_r_2: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => postfix_buffer_reg_r_1_n_0,
      Q => postfix_buffer_reg_r_2_n_0,
      R => \postfix_buffer[66]_i_1_n_0\
    );
postfix_buffer_reg_r_3: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => postfix_buffer_reg_r_2_n_0,
      Q => postfix_buffer_reg_r_3_n_0,
      R => \postfix_buffer[66]_i_1_n_0\
    );
postfix_buffer_reg_r_4: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => postfix_buffer_reg_r_3_n_0,
      Q => postfix_buffer_reg_r_4_n_0,
      R => \postfix_buffer[66]_i_1_n_0\
    );
postfix_buffer_reg_r_5: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => postfix_buffer_reg_r_4_n_0,
      Q => postfix_buffer_reg_r_5_n_0,
      R => \postfix_buffer[66]_i_1_n_0\
    );
postfix_buffer_reg_r_6: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \postfix_buffer[66]_i_2_n_0\,
      D => postfix_buffer_reg_r_5_n_0,
      Q => postfix_buffer_reg_r_6_n_0,
      R => \postfix_buffer[66]_i_1_n_0\
    );
\prefix_buffer[100]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[108]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[100]_i_1_n_0\
    );
\prefix_buffer[101]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[109]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[101]_i_1_n_0\
    );
...
\prefix_buffer[109]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\prefix_buffer[131]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[128]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[131]_i_1_n_0\
    );
\prefix_buffer[134]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[142]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[134]_i_1_n_0\
    );
\prefix_buffer[136]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
      I0 => prefix_buffer(6),
      I1 => m00_axis_aresetn,
      O => \prefix_buffer[136]_i_1_n_0\
    );
\prefix_buffer[136]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
      ...
      I1 => current_state(0),
      I2 => current_state(1),
      O => \prefix_buffer[136]_i_2_n_0\
    );
\prefix_buffer[13]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[21]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[13]_i_1_n_0\
    );
\prefix_buffer[142]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[150]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[142]_i_1_n_0\
    );
...
\prefix_buffer[150]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000FF0020"
    )
        port map (
      I0 => send_trigger_reg_n_0,
      I1 => fifo_full,
      I2 => axis_ready,
      I3 => current_state(1),
      I4 => current_state(0),
...
\prefix_buffer[150]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\prefix_buffer[18]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[26]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[18]_i_1_n_0\
    );
...
\prefix_buffer[21]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[29]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[21]_i_1_n_0\
    );
...
\prefix_buffer[29]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[37]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[29]_i_1_n_0\
    );
\prefix_buffer[2]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[10]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[2]_i_1_n_0\
    );
...
\prefix_buffer[34]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[42]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[34]_i_1_n_0\
    );
\prefix_buffer[37]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[45]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[37]_i_1_n_0\
    );
...
\prefix_buffer[41]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[49]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[41]_i_1_n_0\
    );
\prefix_buffer[44]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[52]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[44]_i_1_n_0\
    );
\prefix_buffer[45]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[53]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[45]_i_1_n_0\
    );
...
\prefix_buffer[53]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[61]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[53]_i_1_n_0\
    );
...
\prefix_buffer[58]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[66]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[58]_i_1_n_0\
    );
...
\prefix_buffer[61]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[69]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[61]_i_1_n_0\
    );
...
\prefix_buffer[64]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[72]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[64]_i_1_n_0\
    );
\prefix_buffer[66]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[74]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[66]_i_1_n_0\
    );
\prefix_buffer[68]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[76]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[68]_i_1_n_0\
    );
...
\prefix_buffer[70]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[78]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[70]_i_1_n_0\
    );
...
\prefix_buffer[76]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[84]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[76]_i_1_n_0\
    );
\prefix_buffer[77]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[85]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[77]_i_1_n_0\
    );
...
\prefix_buffer[80]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[88]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[80]_i_1_n_0\
    );
\prefix_buffer[82]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[90]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[82]_i_1_n_0\
    );
\prefix_buffer[85]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[93]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[85]_i_1_n_0\
    );
...
\prefix_buffer[93]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \prefix_buffer_reg_n_0_[101]\,
      I1 => prefix_buffer(6),
      O => \prefix_buffer[93]_i_1_n_0\
    );
...
\prefix_buffer_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[136]_i_2_n_0\,
      D => \prefix_buffer_reg_n_0_[8]\,
      Q => \prefix_buffer_reg_n_0_[0]\,
      R => \prefix_buffer[136]_i_1_n_0\
    );
\prefix_buffer_reg[100]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[150]_i_1_n_0\,
      D => \prefix_buffer[100]_i_1_n_0\,
      Q => \prefix_buffer_reg_n_0_[100]\,
      R => debounce_i_n_0
    );
\prefix_buffer_reg[101]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[150]_i_1_n_0\,
      D => \prefix_buffer[101]_i_1_n_0\,
      Q => \prefix_buffer_reg_n_0_[101]\,
      R => debounce_i_n_0
    );
...
\prefix_buffer_reg[108]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[136]_i_2_n_0\,
      D => prefix_buffer_reg_gate_n_0,
      Q => \prefix_buffer_reg_n_0_[108]\,
      R => \prefix_buffer[136]_i_1_n_0\
    );
\prefix_buffer_reg[109]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[150]_i_1_n_0\,
      D => \prefix_buffer[109]_i_1_n_0\,
      Q => \prefix_buffer_reg_n_0_[109]\,
      R => debounce_i_n_0
    );
...
\prefix_buffer_reg[113]_inst_sw_axis_i_prefix_buffer_reg_r_8\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[136]_i_2_n_0\,
      D => \prefix_buffer_reg[121]_srl2___inst_sw_axis_i_prefix_buffer_reg_r_7_n_0\,
      Q => \prefix_buffer_reg[113]_inst_sw_axis_i_prefix_buffer_reg_r_8_n_0\,
      R => '0'
    );
\prefix_buffer_reg[114]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[136]_i_2_n_0\,
      D => \prefix_buffer_reg_n_0_[122]\,
      Q => \prefix_buffer_reg_n_0_[114]\,
      R => \prefix_buffer[136]_i_1_n_0\
    );
\prefix_buffer_reg[116]_inst_sw_axis_i_prefix_buffer_reg_r_9\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[136]_i_2_n_0\,
      D => \prefix_buffer_reg[124]_srl3___inst_sw_axis_i_prefix_buffer_reg_r_8_n_0\,
      Q => \prefix_buffer_reg[116]_inst_sw_axis_i_prefix_buffer_reg_r_9_n_0\,
      R => '0'
    );
...
\prefix_buffer_reg[121]_srl2___inst_sw_axis_i_prefix_buffer_reg_r_7\: unisim.vcomponents.SRL16E
     port map (
      A0 => '1',
      A1 => '0',
      A2 => '0',
      ...
      CE => \prefix_buffer[136]_i_2_n_0\,
      CLK => m00_axis_aclk,
      D => \prefix_buffer_reg_n_0_[134]\,
      Q => \prefix_buffer_reg[121]_srl2___inst_sw_axis_i_prefix_buffer_reg_r_7_n_0\
    );
...
\prefix_buffer_reg[124]_srl3___inst_sw_axis_i_prefix_buffer_reg_r_8\: unisim.vcomponents.SRL16E
     port map (
      A0 => '0',
      A1 => '1',
      A2 => '0',
      ...
      CE => \prefix_buffer[136]_i_2_n_0\,
      CLK => m00_axis_aclk,
      D => \prefix_buffer_reg_n_0_[136]\,
      Q => \prefix_buffer_reg[124]_srl3___inst_sw_axis_i_prefix_buffer_reg_r_8_n_0\
    );
...
\prefix_buffer_reg[131]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[150]_i_1_n_0\,
      D => \prefix_buffer[131]_i_1_n_0\,
      Q => \prefix_buffer_reg_n_0_[131]\,
      R => debounce_i_n_0
    );
...
\prefix_buffer_reg[13]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[150]_i_1_n_0\,
      D => \prefix_buffer[13]_i_1_n_0\,
      Q => \prefix_buffer_reg_n_0_[13]\,
      R => debounce_i_n_0
    );
...
\prefix_buffer_reg[17]_srl3___inst_sw_axis_i_prefix_buffer_reg_r_8\: unisim.vcomponents.SRL16E
     port map (
      A0 => '0',
      A1 => '1',
      A2 => '0',
      ...
      CE => \prefix_buffer[136]_i_2_n_0\,
      CLK => m00_axis_aclk,
      D => \prefix_buffer_reg_n_0_[41]\,
      Q => \prefix_buffer_reg[17]_srl3___inst_sw_axis_i_prefix_buffer_reg_r_8_n_0\
    );
\prefix_buffer_reg[18]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[150]_i_1_n_0\,
      D => \prefix_buffer[18]_i_1_n_0\,
...
\prefix_buffer_reg[21]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[150]_i_1_n_0\,
      D => \prefix_buffer[21]_i_1_n_0\,
      Q => \prefix_buffer_reg_n_0_[21]\,
      R => debounce_i_n_0
    );
...
\prefix_buffer_reg[29]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[150]_i_1_n_0\,
      D => \prefix_buffer[29]_i_1_n_0\,
      Q => \prefix_buffer_reg_n_0_[29]\,
      R => debounce_i_n_0
    );
...
\prefix_buffer_reg[34]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[150]_i_1_n_0\,
      D => \prefix_buffer[34]_i_1_n_0\,
      Q => \prefix_buffer_reg_n_0_[34]\,
      R => debounce_i_n_0
    );
\prefix_buffer_reg[35]_inst_sw_axis_i_prefix_buffer_reg_r_17\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[136]_i_2_n_0\,
      D => \prefix_buffer_reg[43]_srl11___inst_sw_axis_i_prefix_buffer_reg_r_16_n_0\,
      Q => \prefix_buffer_reg[35]_inst_sw_axis_i_prefix_buffer_reg_r_17_n_0\,
      R => '0'
    );
...
\prefix_buffer_reg[37]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[150]_i_1_n_0\,
      D => \prefix_buffer[37]_i_1_n_0\,
      Q => \prefix_buffer_reg_n_0_[37]\,
      R => debounce_i_n_0
    );
...
\prefix_buffer_reg[43]_srl11___inst_sw_axis_i_prefix_buffer_reg_r_16\: unisim.vcomponents.SRL16E
     port map (
      A0 => '0',
      A1 => '1',
      A2 => '0',
      ...
      CE => \prefix_buffer[136]_i_2_n_0\,
      CLK => m00_axis_aclk,
      D => \prefix_buffer_reg_n_0_[131]\,
      Q => \prefix_buffer_reg[43]_srl11___inst_sw_axis_i_prefix_buffer_reg_r_16_n_0\
    );
\prefix_buffer_reg[44]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[150]_i_1_n_0\,
      D => \prefix_buffer[44]_i_1_n_0\,
      Q => \prefix_buffer_reg_n_0_[44]\,
      R => debounce_i_n_0
    );
\prefix_buffer_reg[45]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[150]_i_1_n_0\,
      D => \prefix_buffer[45]_i_1_n_0\,
      Q => \prefix_buffer_reg_n_0_[45]\,
      R => debounce_i_n_0
    );
...
\prefix_buffer_reg[53]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[150]_i_1_n_0\,
      D => \prefix_buffer[53]_i_1_n_0\,
      Q => \prefix_buffer_reg_n_0_[53]\,
      R => debounce_i_n_0
    );
...
\prefix_buffer_reg[61]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[150]_i_1_n_0\,
      D => \prefix_buffer[61]_i_1_n_0\,
      Q => \prefix_buffer_reg_n_0_[61]\,
      R => debounce_i_n_0
    );
...
\prefix_buffer_reg[66]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[150]_i_1_n_0\,
      D => \prefix_buffer[66]_i_1_n_0\,
      Q => \prefix_buffer_reg_n_0_[66]\,
      R => debounce_i_n_0
    );
...
\prefix_buffer_reg[74]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[136]_i_2_n_0\,
      D => \prefix_buffer_reg_n_0_[82]\,
      Q => \prefix_buffer_reg_n_0_[74]\,
      R => \prefix_buffer[136]_i_1_n_0\
    );
\prefix_buffer_reg[76]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[150]_i_1_n_0\,
      D => \prefix_buffer[76]_i_1_n_0\,
      Q => \prefix_buffer_reg_n_0_[76]\,
      R => debounce_i_n_0
    );
...
\prefix_buffer_reg[82]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[150]_i_1_n_0\,
      D => \prefix_buffer[82]_i_1_n_0\,
      Q => \prefix_buffer_reg_n_0_[82]\,
      R => debounce_i_n_0
    );
\prefix_buffer_reg[84]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[136]_i_2_n_0\,
      D => \prefix_buffer_reg_n_0_[92]\,
      Q => \prefix_buffer_reg_n_0_[84]\,
      R => \prefix_buffer[136]_i_1_n_0\
    );
\prefix_buffer_reg[85]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[150]_i_1_n_0\,
      D => \prefix_buffer[85]_i_1_n_0\,
      Q => \prefix_buffer_reg_n_0_[85]\,
      R => debounce_i_n_0
    );
...
\prefix_buffer_reg[90]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[136]_i_2_n_0\,
      D => \prefix_buffer_reg_n_0_[98]\,
      Q => \prefix_buffer_reg_n_0_[90]\,
      R => \prefix_buffer[136]_i_1_n_0\
    );
\prefix_buffer_reg[92]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[136]_i_2_n_0\,
      D => \prefix_buffer_reg_n_0_[100]\,
      Q => \prefix_buffer_reg_n_0_[92]\,
      R => \prefix_buffer[136]_i_1_n_0\
    );
\prefix_buffer_reg[93]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[150]_i_1_n_0\,
      D => \prefix_buffer[93]_i_1_n_0\,
      Q => \prefix_buffer_reg_n_0_[93]\,
      R => debounce_i_n_0
    );
...
\prefix_buffer_reg[98]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[136]_i_2_n_0\,
      D => \prefix_buffer_reg_n_0_[106]\,
      Q => \prefix_buffer_reg_n_0_[98]\,
      R => \prefix_buffer[136]_i_1_n_0\
    );
\prefix_buffer_reg[9]_inst_sw_axis_i_prefix_buffer_reg_r_9\: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[136]_i_2_n_0\,
      D => \prefix_buffer_reg[17]_srl3___inst_sw_axis_i_prefix_buffer_reg_r_8_n_0\,
      Q => \prefix_buffer_reg[9]_inst_sw_axis_i_prefix_buffer_reg_r_9_n_0\,
      R => '0'
    );
prefix_buffer_reg_gate: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
        ...
        port map (
      I0 => \prefix_buffer_reg[116]_inst_sw_axis_i_prefix_buffer_reg_r_9_n_0\,
...
\prefix_buffer_reg_gate__0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
        ...
        port map (
      I0 => \prefix_buffer_reg[113]_inst_sw_axis_i_prefix_buffer_reg_r_8_n_0\,
      I1 => prefix_buffer_reg_r_8_n_0,
...
\prefix_buffer_reg_gate__1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
        ...
        port map (
      I0 => \prefix_buffer_reg[35]_inst_sw_axis_i_prefix_buffer_reg_r_17_n_0\,
      I1 => prefix_buffer_reg_r_17_n_0,
...
\prefix_buffer_reg_gate__2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
        ...
        port map (
      I0 => \prefix_buffer_reg[9]_inst_sw_axis_i_prefix_buffer_reg_r_9_n_0\,
      I1 => prefix_buffer_reg_r_9_n_0,
...
prefix_buffer_reg_r_10: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[136]_i_2_n_0\,
      D => prefix_buffer_reg_r_9_n_0,
      Q => prefix_buffer_reg_r_10_n_0,
      R => \prefix_buffer[136]_i_1_n_0\
    );
prefix_buffer_reg_r_11: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[136]_i_2_n_0\,
      D => prefix_buffer_reg_r_10_n_0,
      Q => prefix_buffer_reg_r_11_n_0,
      R => \prefix_buffer[136]_i_1_n_0\
    );
prefix_buffer_reg_r_12: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[136]_i_2_n_0\,
      D => prefix_buffer_reg_r_11_n_0,
      Q => prefix_buffer_reg_r_12_n_0,
      R => \prefix_buffer[136]_i_1_n_0\
    );
prefix_buffer_reg_r_13: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[136]_i_2_n_0\,
      D => prefix_buffer_reg_r_12_n_0,
      Q => prefix_buffer_reg_r_13_n_0,
      R => \prefix_buffer[136]_i_1_n_0\
    );
prefix_buffer_reg_r_14: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[136]_i_2_n_0\,
      D => prefix_buffer_reg_r_13_n_0,
      Q => prefix_buffer_reg_r_14_n_0,
      R => \prefix_buffer[136]_i_1_n_0\
    );
prefix_buffer_reg_r_15: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[136]_i_2_n_0\,
      D => prefix_buffer_reg_r_14_n_0,
      Q => prefix_buffer_reg_r_15_n_0,
      R => \prefix_buffer[136]_i_1_n_0\
    );
prefix_buffer_reg_r_16: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[136]_i_2_n_0\,
      D => prefix_buffer_reg_r_15_n_0,
      Q => prefix_buffer_reg_r_16_n_0,
      R => \prefix_buffer[136]_i_1_n_0\
    );
prefix_buffer_reg_r_17: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => \prefix_buffer[136]_i_2_n_0\,
      D => prefix_buffer_reg_r_16_n_0,
      Q => prefix_buffer_reg_r_17_n_0,
      R => \prefix_buffer[136]_i_1_n_0\
    );
...
send_trigger_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
      I0 => send_trigger_i_2_n_0,
      I1 => send_trigger_i_3_n_0,
      I2 => send_trigger_i_4_n_0,
      I3 => send_trigger_i_5_n_0,
      O => send_trigger
    );
send_trigger_i_2: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => timer_reg(16),
      I5 => timer_reg(15),
      O => send_trigger_i_2_n_0
    );
send_trigger_i_3: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => timer_reg(21),
      I5 => timer_reg(22),
      O => send_trigger_i_3_n_0
    );
send_trigger_i_4: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000002000000000"
    )
        port map (
      ...
      I4 => timer_reg(10),
      I5 => timer_reg(9),
      O => send_trigger_i_4_n_0
    );
send_trigger_i_5: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
      ...
      I3 => timer_reg(4),
      I4 => timer_reg(3),
      O => send_trigger_i_5_n_0
    );
send_trigger_reg: unisim.vcomponents.FDRE
     port map (
      C => m00_axis_aclk,
      CE => '1',
      D => send_trigger,
      Q => send_trigger_reg_n_0,
      R => debounce_i_n_0
    );
...
\state_counter[0]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AA000000AA0CCC0C"
    )
        port map (
      I0 => \data_buffer[30]_i_3_n_0\,
      I1 => \state_counter[0]_i_8_n_0\,
      I2 => current_state(1),
      I3 => state_counter_reg(4),
      I4 => current_state(0),
      I5 => current_state(2),
...
\state_counter[0]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F0F0F070"
    )
        port map (
...
\state_counter[0]_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\state_counter[0]_i_8\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
\state_counter[0]_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B888"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity eth_axis_gpio_0_0_axis_gpio_v1_0 is
  port (
    m00_axis_tvalid : out STD_LOGIC;
    m00_axis_tdata : out STD_LOGIC_VECTOR ( 7 downto 0 );
    m00_axis_tlast : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of eth_axis_gpio_0_0_axis_gpio_v1_0 : entity is "axis_gpio_v1_0";
end eth_axis_gpio_0_0_axis_gpio_v1_0;

architecture STRUCTURE of eth_axis_gpio_0_0_axis_gpio_v1_0 is
begin
axis_gpio_i: entity work.eth_axis_gpio_0_0_axis_gpio
     port map (
      LED(15 downto 0) => LED(15 downto 0),
...
sw_axis_i: entity work.eth_axis_gpio_0_0_sw_axis
     port map (
      SW(15 downto 0) => SW(15 downto 0),
      m00_axis_aclk => m00_axis_aclk,
      m00_axis_aresetn => m00_axis_aresetn,
...
entity eth_axis_gpio_0_0 is
  ...
  attribute NotValidForBitStream of eth_axis_gpio_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of eth_axis_gpio_0_0 : entity is "eth_axis_gpio_0_0,axis_gpio_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of eth_axis_gpio_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of eth_axis_gpio_0_0 : entity is "axis_gpio_v1_0,Vivado 2024.1";
end eth_axis_gpio_0_0;

architecture STRUCTURE of eth_axis_gpio_0_0 is
  signal \<const0>\ : STD_LOGIC;
...
inst: entity work.eth_axis_gpio_0_0_axis_gpio_v1_0
     port map (
      LED(15 downto 0) => LED(15 downto 0),
      SW(15 downto 0) => SW(15 downto 0),
      m00_axis_aclk => m00_axis_aclk,
