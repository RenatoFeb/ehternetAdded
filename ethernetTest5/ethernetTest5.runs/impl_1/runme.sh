...
HD_PWD='C:/Users/rfebb/Desktop/Projects/ethernetTest5/ethernetTest5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eth_wrapper.tcl -notrace
