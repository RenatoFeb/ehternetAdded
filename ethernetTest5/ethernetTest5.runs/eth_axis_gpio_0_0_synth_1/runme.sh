...
HD_PWD='C:/Users/rfebb/Desktop/Projects/ethernetTest5/ethernetTest5.runs/eth_axis_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_axis_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eth_axis_gpio_0_0.tcl
