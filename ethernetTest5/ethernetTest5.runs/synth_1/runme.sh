...
HD_PWD='C:/Users/rfebb/Desktop/Projects/ethernetTest5/ethernetTest5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eth_wrapper.tcl
