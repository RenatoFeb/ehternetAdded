...
#
# Script generated by Vivado on Thu Feb 26 13:16:09 -0500 2026
...
#
# Usage        : eth.sh
#                eth.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                eth.sh [-reset_run]
#                eth.sh [-reset_log]
#                eth.sh [-help]
#
...
#                script (type 'eth.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname fifo_generator_v13_2_10 -libname xil_defaultlib -libname lib_cdc_v1_0_3 -libname proc_sys_reset_v5_0_15 -libname axis_infrastructure_v1_1_1 -libname axis_data_fifo_v2_0_13 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm fifo_generator_v13_2_10 xil_defaultlib lib_cdc_v1_0_3 proc_sys_reset_v5_0_15 axis_infrastructure_v1_1_1 axis_data_fifo_v2_0_13)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "eth.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./eth.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ipshared/3242" +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ip/eth_axis_gpio_0_0/src/axis_data_fifo_tuser/hdl" \
  ...
  xmvlog -work fifo_generator_v13_2_10 $xmvlog_opts +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ipshared/3242" +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ip/eth_axis_gpio_0_0/src/axis_data_fifo_tuser/hdl" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ipshared/3242" +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ip/eth_axis_gpio_0_0/src/axis_data_fifo_tuser/hdl" \
  "../../../bd/eth/ip/eth_rmii_axis_0_0/src/data_fifo/sim/data_fifo.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ipshared/3242" +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ip/eth_axis_gpio_0_0/src/axis_data_fifo_tuser/hdl" \
  ...
  xmvlog -work axis_infrastructure_v1_1_1 $xmvlog_opts +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ipshared/3242" +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ip/eth_axis_gpio_0_0/src/axis_data_fifo_tuser/hdl" \
  "../../../../ethernetTest5.gen/sources_1/bd/eth/ip/eth_axis_gpio_0_0/src/axis_data_fifo_tuser/hdl/axis_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axis_data_fifo_v2_0_13 $xmvlog_opts +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ipshared/3242" +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ip/eth_axis_gpio_0_0/src/axis_data_fifo_tuser/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.eth xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.eth -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log eth_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./eth.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: eth.sh [-help]\n\
Usage: eth.sh [-step]\n\
Usage: eth.sh [-lib_map_path]\n\
Usage: eth.sh [-reset_run]\n\
Usage: eth.sh [-reset_log]\n\
Usage: eth.sh [-keep_index]\n\
Usage: eth.sh [-noclean_files]\n\n\
