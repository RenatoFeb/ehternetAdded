...
design_libs=(xpm fifo_generator_v13_2_10 xil_defaultlib lib_cdc_v1_0_3 proc_sys_reset_v5_0_15 axis_infrastructure_v1_1_1 axis_data_fifo_v2_0_13)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ipshared/3242" +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ip/eth_axis_gpio_0_0/src/axis_data_fifo_tuser/hdl" \
  ...
  vlogan -work fifo_generator_v13_2_10 $vlogan_opts +v2k +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ipshared/3242" +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ip/eth_axis_gpio_0_0/src/axis_data_fifo_tuser/hdl" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ipshared/3242" +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ip/eth_axis_gpio_0_0/src/axis_data_fifo_tuser/hdl" \
  "../../../bd/eth/ip/eth_rmii_axis_0_0/src/data_fifo/sim/data_fifo.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ipshared/3242" +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ip/eth_axis_gpio_0_0/src/axis_data_fifo_tuser/hdl" \
  ...
  vlogan -work axis_infrastructure_v1_1_1 $vlogan_opts +v2k +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ipshared/3242" +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ip/eth_axis_gpio_0_0/src/axis_data_fifo_tuser/hdl" \
  "../../../../ethernetTest5.gen/sources_1/bd/eth/ip/eth_axis_gpio_0_0/src/axis_data_fifo_tuser/hdl/axis_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axis_data_fifo_v2_0_13 $vlogan_opts +v2k +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ipshared/3242" +incdir+"../../../../ethernetTest5.gen/sources_1/bd/eth/ip/eth_axis_gpio_0_0/src/axis_data_fifo_tuser/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.eth xil_defaultlib.glbl -o eth_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./eth_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key eth_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc eth_simv.daidir vcs_lib c.obj)
