...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_10 -L xil_defaultlib -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_15 -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_13 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot eth xil_defaultlib.eth xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim eth -key {Behavioral:sim_1:Functional:eth} -tclbatch cmd.tcl -protoinst "protoinst_files/eth.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib fifo_generator_v13_2_10 axis_infrastructure_v1_1_1 axis_data_fifo_v2_0_13)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb eth.wdb xsim.dir libdpi.so)
